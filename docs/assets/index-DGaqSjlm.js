...
const Wr = !1,
  ...
  Jn = typeof Proxy == "function",
  tn = Symbol("solid-track"),
  mt = { equals: Yr };
let Un = tr;
const Pe = 1, ht = 2, Wn = { owned: null, cleanups: null, context: null, owner: null };
var L = null;
let Ft = null, Qr = null, N = null, j = null, de = null, _t = 0;
function Ee(t, e) {
  const n = N,
    r = L,
    o = t.length === 0,
    i = e === void 0 ? r : e,
    s = o ? Wn : { owned: null, cleanups: null, context: i ? i.context : null, owner: i },
    a = o ? t : () => t(() => Z(() => We(s)));
  L = s, N = null;
  try {
    return we(a, !0);
...
function T(t, e) {
  ...
  const n = { value: t, observers: null, observerSlots: null, comparator: e.equals || void 0 },
    r = o => (typeof o == "function" && (o = o(n.value)), er(n, o));
  return [Zn.bind(n), r];
}
function D(t, e, n) {
  const r = fn(t, e, !1, Pe);
...
function se(t, e, n) {
  Un = no;
  const r = fn(t, e, !1, Pe);
  (!n || !n.render) && (r.user = !0), de ? de.push(r) : et(r);
}
function M(t, e, n) {
  n = n ? Object.assign({}, mt, n) : mt;
  const r = fn(t, e, !0, 0);
  return r.observers = null, r.observerSlots = null, r.comparator = n.equals || void 0, et(r), Zn.bind(r);
}
function Yn(t) {
  return we(t, !1);
}
...
function Te(t, e, n) {
  ...
  return s => {
    ...
    if (r) {
      a = Array(t.length);
      for (let c = 0; c < t.length; c++) a[c] = t[c]();
    } else a = t();
    if (i) return i = !1, s;
    const l = Z(() => e(a, o, s));
    return o = a, l;
...
function Zr(t) {
  ...
  return Promise.resolve().then(() => {
    N = e, L = n;
    let r;
    return we(t, !1), N = L = null, r ? r.done : void 0;
  });
}
const [Qc, Zc] = T(!1);
function Se(t, e) {
  const n = Symbol("context");
  return { id: n, Provider: oo(n), defaultValue: t };
}
function me(t) {
  let e;
...
function Zn() {
  if (this.sources && this.state) {
    if (this.state === Pe) et(this);
    else {
      const t = j;
      j = null, we(() => gt(this), !1), j = t;
    }
  }
  if (N) {
    const t = this.observers ? this.observers.length : 0;
    N.sources ? (N.sources.push(this), N.sourceSlots.push(t)) : (N.sources = [this], N.sourceSlots = [t]),
      this.observers
        ? (this.observers.push(N), this.observerSlots.push(N.sources.length - 1))
        : (this.observers = [N], this.observerSlots = [N.sources.length - 1]);
  }
  return this.value;
}
function er(t, e, n) {
  let r = t.value;
  return (!t.comparator || !t.comparator(r, e)) && (t.value = e,
    t.observers && t.observers.length && we(() => {
      for (let o = 0; o < t.observers.length; o += 1) {
        const i = t.observers[o], s = Ft && Ft.running;
        s && Ft.disposed.has(i),
          (s ? !i.tState : !i.state) && (i.pure ? j.push(i) : de.push(i), i.observers && nr(i)),
          s || (i.state = Pe);
      }
...
function eo(t, e, n) {
  ...
  try {
    ...
    return t.pure && (t.state = Pe, t.owned && t.owned.forEach(We), t.owned = null), t.updatedAt = n + 1, gn(s);
  } finally {
    N = i, L = o;
  }
  (!t.updatedAt || t.updatedAt <= n)
    && (t.updatedAt != null && "observers" in t ? er(t, r) : t.value = r, t.updatedAt = n);
}
function fn(t, e, n, r = Pe, o) {
  const i = {
    fn: t,
    state: r,
    updatedAt: null,
  ...
  return L === null || L !== Wn && (L.owned ? L.owned.push(i) : L.owned = [i]), i;
}
function ft(t) {
  if (t.state === 0) return;
  if (t.state === ht) return gt(t);
  if (t.suspense && Z(t.suspense.inFallback)) return t.suspense.effects.push(t);
  const e = [t];
  for (; (t = t.owner) && (!t.updatedAt || t.updatedAt < _t);) t.state && e.push(t);
  for (let n = e.length - 1; n >= 0; n--) {
    if (t = e[n], t.state === Pe) et(t);
    else if (t.state === ht) {
      const r = j;
      j = null, we(() => gt(t, e[0]), !1), j = r;
    }
  }
}
function we(t, e) {
  ...
  try {
    ...
    n || (de = null), j = null, gn(r);
  }
}
function to(t) {
  if (j && (tr(j), j = null), t) return;
  const e = de;
  de = null, e.length && we(() => Un(e), !1);
}
function tr(t) {
...
function gt(t, e) {
  ...
  for (let n = 0; n < t.sources.length; n += 1) {
    ...
    if (r.sources) {
      const o = r.state;
      o === Pe ? r !== e && (!r.updatedAt || r.updatedAt < _t) && ft(r) : o === ht && gt(r, e);
    }
  }
}
function nr(t) {
  for (let e = 0; e < t.observers.length; e += 1) {
    ...
    n.state || (n.state = ht, n.pure ? j.push(n) : de.push(n), n.observers && nr(n));
  }
}
function We(t) {
  let e;
...
function rn(t) {
  if (typeof t == "function" && !t.length) return rn(t());
  if (Array.isArray(t)) {
    const e = [];
...
function oo(t, e) {
  return function(r) {
    let o;
    return D(() => o = Z(() => (L.context = { ...L.context, [t]: r.value }, hn(() => r.children))), void 0), o;
  };
}
const io = Symbol("fallback");
function $n(t) {
  for (let e = 0; e < t.length; e++) t[e]();
}
function so(t, e, n = {}) {
  let r = [], o = [], i = [], s = 0, a = e.length > 1 ? [] : null;
  return ne(() => $n(i)), () => {
    let l = t() || [], c = l.length, p, u;
    return l[tn],
      Z(() => {
        let f, g, b, y, P, S, $, _, R;
        if (c === 0) {
          s !== 0 && ($n(i), i = [], r = [], o = [], s = 0, a && (a = [])),
            n.fallback && (r = [io], o[0] = Ee(H => (i[0] = H, n.fallback())), s = 1);
        } else if (s === 0) {
          for (o = new Array(c), u = 0; u < c; u++) r[u] = l[u], o[u] = Ee(h);
          s = c;
        } else {
          for (
            b = new Array(c), y = new Array(c), a && (P = new Array(c)), S = 0, $ = Math.min(s, c);
            S < $ && r[S] === l[S];
            S++
          );
          for ($ = s - 1, _ = c - 1; $ >= S && _ >= S && r[$] === l[_]; $--, _--) {
            b[_] = o[$], y[_] = i[$], a && (P[_] = a[$]);
          }
          for (f = new Map(), g = new Array(_ + 1), u = _; u >= S; u--) {
            R = l[u], p = f.get(R), g[u] = p === void 0 ? -1 : p, f.set(R, u);
          }
          for (p = S; p <= $; p++) {
            R = r[p],
              u = f.get(R),
              u !== void 0 && u !== -1
                ? (b[u] = o[p], y[u] = i[p], a && (P[u] = a[p]), u = g[u], f.set(R, u))
                : i[p]();
          }
          for (u = S; u < c; u++) u in b ? (o[u] = b[u], i[u] = y[u], a && (a[u] = P[u], a[u](u))) : o[u] = Ee(h);
...
const on = {
  get(t, e, n) {
    return e === te ? n : t.get(e);
  },
  has(t, e) {
    return e === te ? !0 : t.has(e);
  },
  set: at,
  deleteProperty: at,
...
function A(...t) {
  ...
  for (let s = 0; s < t.length; s++) {
    const a = t[s];
    e = e || !!a && te in a, t[s] = typeof a == "function" ? (e = !0, M(a)) : a;
  }
  if (Jn && e) {
    return new Proxy({
      get(s) {
      ...
      has(s) {
        for (let a = t.length - 1; a >= 0; a--) if (s in zt(t[a])) return !0;
        return !1;
      },
      keys() {
        const s = [];
        for (let a = 0; a < t.length; a++) s.push(...Object.keys(zt(t[a])));
        return [...new Set(s)];
      },
    }, on);
  }
  ...
  for (let s = t.length - 1; s >= 0; s--) {
    ...
    for (let c = l.length - 1; c >= 0; c--) {
      ...
      const u = Object.getOwnPropertyDescriptor(a, p);
      if (!r[p]) {
        r[p] = u.get
          ? { enumerable: !0, configurable: !0, get: ao.bind(n[p] = [u.get.bind(a)]) }
          : u.value !== void 0
          ? u
          : void 0;
      } else {
  ...
  for (let s = i.length - 1; s >= 0; s--) {
    const a = i[s], l = r[a];
    l && l.get ? Object.defineProperty(o, a, l) : o[a] = l ? l.value : void 0;
  }
  return o;
}
function x(t, ...e) {
  ...
  if (Jn && te in t) {
    ...
    return i.push(
      new Proxy({
        get(s) {
          return o.includes(s) ? void 0 : t[s];
        },
        has(s) {
          return o.includes(s) ? !1 : s in t;
        },
        keys() {
          return Object.keys(t).filter(s => !o.includes(s));
        },
      }, on),
    ),
      i;
...
const co = t => `Stale read from <${t}>.`;
function Y(t) {
  const e = "fallback" in t && { fallback: () => t.fallback };
  return M(so(() => t.each, t.children, e || void 0));
}
function k(t) {
  const e = t.keyed, n = M(() => t.when, void 0, void 0), r = e ? n : M(n, void 0, { equals: (o, i) => !o == !i });
  return M(
    () => {
      const o = r();
      if (o) {
...
const uo = [
  ...
  mo = new Set(["innerHTML", "textContent", "innerText", "children"]),
  ho = Object.assign(Object.create(null), { className: "class", htmlFor: "for" }),
  fo = Object.assign(Object.create(null), {
    class: "className",
...
const bo = new Set([
  ...
  U = t => M(() => t());
function yo(t, e, n) {
  let r = n.length, o = e.length, i = r, s = 0, a = 0, l = e[o - 1].nextSibling, c = null;
  for (; s < o || a < i;) {
    if (e[s] === n[a]) {
      s++, a++;
      continue;
    ...
    for (; e[o - 1] === n[i - 1];) o--, i--;
    if (o === s) {
      const p = i < r ? a ? n[a - 1].nextSibling : n[i - a] : l;
      for (; a < i;) t.insertBefore(n[a++], p);
    } else if (i === a) { for (; s < o;) (!c || !c.has(e[s])) && e[s].remove(), s++; }
    else if (e[s] === n[i - 1] && n[a] === e[o - 1]) {
      const p = e[--o].nextSibling;
      t.insertBefore(n[a++], e[s++].nextSibling), t.insertBefore(n[--i], p), e[o] = n[i];
    } else {
      if (!c) {
        c = new Map();
        let u = a;
      ...
      if (p != null) {
        if (a < p && p < i) {
          let u = s, h = 1, f;
          for (; ++u < o && u < i && !((f = c.get(e[u])) == null || f !== p + h);) h++;
          if (h > p - a) {
            const g = e[s];
            for (; a < p;) t.insertBefore(n[a++], g);
...
function vo(t, e, n, r = {}) {
  let o;
  return Ee(i => {
    o = i, e === document ? t() : m(e, t(), e.firstChild ? null : void 0, n);
  }, r.owner),
    () => {
      o(), e.textContent = "";
    };
...
function q(t, e = window.document) {
  const n = e[xn] || (e[xn] = new Set());
  for (let r = 0, o = t.length; r < o; r++) {
    const i = t[r];
    n.has(i) || (n.add(i), e.addEventListener(i, xo));
  }
}
function w(t, e, n) {
...
function So(t, e, n = {}) {
  ...
  for (i = 0, s = o.length; i < s; i++) {
    const a = o[i];
    !a || a === "undefined" || e[a] || (_n(t, a, !1), delete n[a]);
  }
  for (i = 0, s = r.length; i < s; i++) {
    const a = r[i], l = !!e[a];
    !a || a === "undefined" || n[a] === l || !l || (_n(t, a, !0), n[a] = l);
  }
  return n;
}
function wo(t, e, n) {
...
function I(t, e = {}, n, r) {
  const o = {};
  return r || D(() => o.children = Ye(t, e.children, o.children)),
    D(() => typeof e.ref == "function" && ye(e.ref, t)),
    D(() => Co(t, e, n, !0, o, !0)),
    o;
}
function ye(t, e, n) {
...
function m(t, e, n, r) {
  if (n !== void 0 && !r && (r = []), typeof e != "function") return Ye(t, e, r, n);
  D(o => Ye(t, e(), o, n), r);
}
function Co(t, e, n, r, o = {}, i = !1) {
  e || (e = {});
  for (const s in o) {
    if (!(s in e)) {
      if (s === "children") continue;
      o[s] = kn(t, s, null, o[s], n, i, e);
    }
  }
  for (const s in e) {
    if (s === "children") continue;
    const a = e[s];
    o[s] = kn(t, s, a, o[s], n, i, e);
  }
}
function $o(t) {
...
function kn(t, e, n, r, o, i, s) {
  let a, l, c, p, u;
  if (e === "style") return wo(t, n, r);
  if (e === "classList") return So(t, n, r);
  if (n === r) return r;
  if (e === "ref") i || n(t);
  else if (e.slice(0, 3) === "on:") {
    const h = e.slice(3);
    r && t.removeEventListener(h, r, typeof r != "function" && r),
      n && t.addEventListener(h, n, typeof n != "function" && n);
  } else if (e.slice(0, 10) === "oncapture:") {
    const h = e.slice(10);
    r && t.removeEventListener(h, r, !0), n && t.addEventListener(h, n, !0);
  } else if (e.slice(0, 2) === "on") {
    const h = e.slice(2).toLowerCase(), f = bo.has(h);
    if (!f && r) {
      const g = Array.isArray(r) ? r[0] : r;
      t.removeEventListener(h, g);
    }
    (f || n) && (rr(t, h, n, f), f && q([h]));
  } else {e.slice(0, 5) === "attr:"
      ? w(t, e.slice(5), n)
      : e.slice(0, 5) === "bool:"
      ? Po(t, e.slice(5), n)
      : (u = e.slice(0, 5) === "prop:") || (c = mo.has(e)) || (p = go(e, t.tagName)) || (l = po.has(e))
          || (a = t.nodeName.includes("-") || "is" in s)
      ? (u && (e = e.slice(5), l = !0),
        e === "class" || e === "className" ? G(t, n) : a && !l && !c ? t[$o(e)] = n : t[p || e] = n)
      : w(t, ho[e] || e, n);}
  return n;
}
function xo(t) {
  ...
  const n = `$$${t.type}`,
    r = t.target,
    o = t.currentTarget,
    i = l => Object.defineProperty(t, "target", { configurable: !0, value: l }),
    s = () => {
      const l = e[n];
      if (l && !e.disabled) {
        const c = e[`${n}Data`];
...
function Ye(t, e, n, r, o) {
  ...
  if (t = s && n[0] && n[0].parentNode || t, i === "string" || i === "number") {
    ...
    if (Array.isArray(e)) {
      ...
      if (sn(a, e, n, o)) return D(() => n = Ye(t, a, n, r, !0)), () => n;
      if (a.length === 0) { if (n = Ie(t, n, r), s) return n; }
      else l ? n.length === 0 ? Dn(t, a, r) : yo(t, n, a) : (n && Ie(t), Dn(t, a));
      n = a;
    } else if (e.nodeType) {
      if (Array.isArray(n)) {
        if (s) return n = Ie(t, n, r, e);
        Ie(t, n, null, e);
...
function sn(t, e, n, r) {
  ...
  for (let i = 0, s = e.length; i < s; i++) {
    let a = e[i], l = n && n[t.length], c;
    if (!(a == null || a === !0 || a === !1)) {
      if ((c = typeof a) == "object" && a.nodeType) t.push(a);
      else if (Array.isArray(a)) o = sn(t, a, l) || o;
      else if (c === "function") {
        if (r) {
          for (; typeof a == "function";) a = a();
          o = sn(t, Array.isArray(a) ? a : [a], Array.isArray(l) ? l : [l]) || o;
        } else t.push(a), o = !0;
      } else {
        const p = String(a);
        l && l.nodeType === 3 && l.data === p ? t.push(l) : t.push(document.createTextNode(p));
      }
    }
  }
  return o;
  ...
  if (e.length) {
    ...
    for (let s = e.length - 1; s >= 0; s--) {
      ...
      if (o !== a) {
        ...
        !i && !s ? l ? t.replaceChild(o, a) : t.insertBefore(o, n) : l && a.remove();
      } else i = !0;
    }
  } else t.insertBefore(o, n);
  return [o];
}
const _o = !1, ko = "http://www.w3.org/2000/svg";
function Do(t, e = !1, n = void 0) {
  return e ? document.createElementNS(ko, t) : document.createElement(t, { is: n });
}
function tt(t) {
  const { useShadow: e } = t, n = document.createTextNode(""), r = () => t.mount || document.body, o = kt();
  let i;
  return se(
    () => {
      i || (i = mn(o, () => M(() => t.children)));
      const s = r();
      if (s instanceof HTMLHeadElement) {
        const [a, l] = T(!1), c = () => l(!0);
        Ee(p => m(s, () => a() ? p() : i(), null)), ne(c);
      } else {
        const a = Do(t.isSVG ? "g" : "div", t.isSVG), l = e && a.attachShadow ? a.attachShadow({ mode: "open" }) : a;
...
function ir() {
  ...
  function r(o, i) {
    if (n) return !(n = !1);
    const s = { to: o, options: i, defaultPrevented: !1, preventDefault: () => s.defaultPrevented = !0 };
    for (const a of t) {
      a.listener({
        ...s,
        from: a.location,
        retry: l => {
          l && (n = !0), a.navigate(o, { ...i, resolve: !1 });
        },
      });
    }
...
function bn() {
  ...
  && window.history.replaceState({ ...window.history.state, _depth: window.history.length - 1 }, ""),
    an = window.history.state._depth;
}
bn();
function Ao(t) {
...
function To(t, e) {
  ...
  return () => {
    const r = an;
    bn();
    const o = r == null ? null : an - r;
    if (n) {
      n = !1;
      return;
    }
    o && e(o) ? (n = !0, window.history.go(-o)) : t();
  };
}
const Io = /^(?:[a-z0-9]+:)?\/\//i, Eo = /^\/+|(\/)\/+$/g, sr = "http://sr";
function De(t, e = !1) {
  const n = t.replace(Eo, "$1");
  return n ? e || /^[?#]/.test(n) ? n : "/" + n : "";
}
function pt(t, e, n) {
  if (Io.test(e)) return;
  const r = De(t), o = n && De(n);
  let i = "";
  return !o || e.startsWith("/") ? i = r : o.toLowerCase().indexOf(r.toLowerCase()) !== 0 ? i = r + o : i = o,
    (i || "/") + De(e, !i);
}
function Bo(t, e) {
...
function Oo(t, e, n) {
  const [r, o] = t.split("/*", 2), i = r.split("/").filter(Boolean), s = i.length;
  return a => {
    const l = a.split("/").filter(Boolean), c = l.length - s;
    if (c < 0 || c > 0 && o === void 0 && !e) return null;
    const p = { path: s ? "" : "/", params: {} }, u = h => n === void 0 ? void 0 : n[h];
    for (let h = 0; h < s; h++) {
      const f = i[h], g = f[0] === ":", b = g ? l[h] : l[h].toLowerCase(), y = g ? f.slice(1) : f.toLowerCase();
      if (g && Mt(b, u(y))) p.params[y] = b;
      else if (g || !Mt(b, y)) return null;
      p.path += `/${b}`;
    }
    if (o) {
      const h = c ? l.slice(-c).join("/") : "";
      if (Mt(h, u(o))) p.params[o] = h;
      else return null;
    }
    return p;
  };
...
function lr(t) {
  const e = new Map(), n = kt();
  return new Proxy({}, {
    get(r, o) {
      return e.has(o) || mn(n, () => e.set(o, M(() => t()[o]))), e.get(o)();
    },
...
function cr(t) {
  ...
  const o = [n, n += e[1]];
  for (; e = /^(\/\:[^\/]+)\?/.exec(r);) o.push(n += e[1]), r = r.slice(e[0].length);
  return cr(r).reduce((i, s) => [...i, ...o.map(a => a + s)], []);
}
const Fo = 100,
  dr = Se(),
  yn = Se(),
  vn = () => Bo(me(dr), "<A> and 'use' router primitives can be only used inside a Route."),
  zo = () => me(yn) || vn().base,
  Mo = t => {
    const e = zo();
    return M(() => e.resolvePath(t()));
  },
  No = t => {
    const e = vn();
    return M(() => {
  ...
  Ho = () => vn().location;
function Go(t, e = "") {
  const { component: n, preload: r, load: o, children: i, info: s } = t,
    a = !i || Array.isArray(i) && !i.length,
    l = { key: t, component: n, preload: r || o, info: s };
  return ur(t.path).reduce((c, p) => {
    for (const u of cr(p)) {
      const h = Ro(e, u);
      let f = a ? h : h.split("/*", 1)[0];
      f = f.split("/").map(g => g.startsWith(":") || g.startsWith("*") ? g : encodeURIComponent(g)).join("/"),
        c.push({ ...l, originalPath: p, pattern: f, matcher: Oo(f, !a, t.matchFilters) });
    }
    return c;
  }, []);
}
function Ko(t, e = 0) {
  return {
    routes: t,
    score: Lo(t[t.length - 1]) * 1e4 - e,
    matcher(n) {
      const r = [];
      for (let o = t.length - 1; o >= 0; o--) {
        const i = t[o], s = i.matcher(n);
        if (!s) return null;
        r.unshift({ ...s, route: i });
      }
      return r;
...
function pr(t, e = "", n = [], r = []) {
  ...
  for (let i = 0, s = o.length; i < s; i++) {
    ...
    if (a && typeof a == "object") {
      ...
      for (const c of l) {
        n.push(c);
        const p = Array.isArray(a.children) && a.children.length === 0;
        if (a.children && !p) pr(a.children, c.pattern, n, r);
        else {
          const u = Ko([...n], r.length);
          r.push(u);
        }
        n.pop();
      }
  ...
  return n.length ? r : r.sort((i, s) => s.score - i.score);
}
function Nt(t, e) {
  for (let n = 0, r = t.length; n < r; n++) {
    const o = t[n].matcher(e);
    if (o) return o;
  }
  return [];
}
    ...
    o = M(
      p => {
        ...
        try {
          ...
          return console.error(`Invalid path ${u}`), p;
        }
      },
      r,
      { equals: (p, u) => p.href === u.href },
    ),
    i = M(() => o().pathname),
    s = M(() => o().search, !0),
    a = M(() => o().hash),
...
function Vo(t, e, n, r = {}) {
  const { signal: [o, i], utils: s = {} } = t,
    a = s.parsePath || (O => O),
    l = s.renderPath || (O => O),
    c = s.beforeLeave || ir(),
    p = pt("", r.base || "");
  if (p === void 0) throw new Error(`${p} is not a valid base path`);
  p && !o().value && i({ value: p, replace: !0, scroll: !1 });
  const [u, h] = T(!1);
  let f;
  const g = (O, F) => {
      F.value === b() && F.state === P() || (f === void 0 && h(!0),
        ke = O,
        f = F,
        Zr(() => {
          f === F && (y(f.value), S(f.state), R[1](K => K.filter(W => W.pending)));
        }).finally(() => {
          f === F && Yn(() => {
            ke = void 0, O === "navigate" && ot(f), h(!1), f = void 0;
          });
        }));
    },
    [b, y] = T(o().value),
    [P, S] = T(o().state),
    $ = qo(b, P, s.queryWrapper),
    _ = [],
    R = T([]),
    H = M(() => typeof r.transformUrl == "function" ? Nt(e(), r.transformUrl($.pathname)) : Nt(e(), $.pathname)),
    le = () => {
      const O = H(), F = {};
      for (let K = 0; K < O.length; K++) Object.assign(F, O[K].params);
      return F;
    },
    qe = s.paramsWrapper ? s.paramsWrapper(le, e) : lr(le),
    $e = {
      pattern: p,
      path: () => p,
      outlet: () => null,
  ...
  return D(Te(o, O => g("native", O), { defer: !0 })), {
    base: $e,
    location: $,
    params: qe,
    isRouting: u,
  ...
  function fe(O, F, K) {
    Z(() => {
      ...
      const W = !F || F[0] === "?",
        { replace: V, resolve: X, scroll: je, state: Ve } = { replace: !1, resolve: !W, scroll: !0, ...K },
        st = X ? O.resolvePath(F) : pt(W && $.pathname || "", F);
      if (st === void 0) throw new Error(`Path '${F}' is not a routable path`);
      if (_.length >= Fo) throw new Error("Too many redirects");
      const Cn = b();
      (st !== Cn || Ve !== P())
        && (_o
          || c.confirm(st, K)
            && (_.push({ value: Cn, replace: V, scroll: je, state: P() }), g("navigate", { value: st, state: Ve })));
    });
  }
  function rt(O) {
    return O = O || me(yn) || $e, (F, K) => fe(O, F, K);
  }
  function ot(O) {
    const F = _[0];
    F && (i({ ...O, replace: F.replace, scroll: F.scroll }), _.length = 0);
  }
  function it(O, F) {
    const K = Nt(e(), O.pathname), W = ke;
    ke = "preload";
    for (let V in K) {
      const { route: X, params: je } = K[V];
      ...
      F && Ve
        && mn(
          ...
          () =>
            Ve({
              params: je,
              location: { pathname: O.pathname, search: O.search, hash: O.hash, query: ar(O), state: null, key: "" },
              intent: "preload",
            }),
        );
    }
...
function Xo(t, e, n, r) {
  const { base: o, location: i, params: s } = t,
    { pattern: a, component: l, preload: c } = r().route,
    p = M(() => r().path);
  l && l.preload && l.preload();
  const u = c ? c({ params: s, location: i, intent: ke || "initial" }) : void 0;
  return {
    parent: e,
    pattern: a,
    path: p,
    outlet: () =>
      l
        ...
        : n(),
    resolvePath(f) {
      return pt(o.path(), f, p());
    },
  };
}
const Jo = t => e => {
  const { base: n } = e, r = hn(() => e.children), o = M(() => pr(r(), e.base || ""));
  let i;
  const s = Vo(t, o, () => i, { base: n, singleFlight: e.singleFlight, transformUrl: e.transformUrl });
  return t.create && t.create(s),
    d(dr.Provider, {
      value: s,
      get children() {
        return d(Uo, {
...
function Uo(t) {
  const e = t.routerState.location,
    ...
    r = M(() =>
      t.preload && Z(() => {
        t.preload({ params: n, location: e, intent: jo() || "initial" });
      })
    );
  return d(k, {
    get when() {
...
function Wo(t) {
  const e = [];
  let n;
  const r = M(Te(t.routerState.matches, (o, i, s) => {
    let a = i && o.length === i.length;
    const l = [];
    for (let c = 0, p = o.length; c < p; c++) {
      const u = i && i[c], h = o[c];
      s && u && h.route.key === u.route.key ? l[c] = s[c] : (a = !1,
        e[c] && e[c](),
        Ee(f => {
          e[c] = f,
            l[c] = Xo(t.routerState, l[c - 1] || t.routerState.base, An(() => r()[c + 1]), () => {
              const g = t.routerState.matches();
              return g[c] ?? g[0];
            });
        }));
    }
    return e.splice(o.length).forEach(c => c()), s && a ? s : (n = l[0], l);
  }));
  return An(() => r() && n)();
}
const An = t => () =>
...
function Yo([t, e], n, r) {
  return [t, r ? o => e(r(o)) : e];
}
function Qo(t) {
  let e = !1;
  const n = o => typeof o == "string" ? { value: o } : o,
    r = Yo(
      T(n(t.get()), { equals: (o, i) => o.value === i.value && o.state === i.state }),
      void 0,
      o => (!e && t.set(o), o),
    );
  return t.init && ne(t.init((o = t.get()) => {
    e = !0, r[1](n(o)), e = !1;
  })),
    Jo({ signal: r, create: t.create, utils: t.utils });
}
function Zo(t, e, n) {
...
const ti = new Map();
function ni(t = !0, e = !1, n = "/_server", r) {
  return o => {
    const i = o.base.path(), s = o.navigatorFactory(o.base);
    let a, l;
    function c(b) {
      return b.namespaceURI === "http://www.w3.org/2000/svg";
    }
    function p(b) {
      if (b.defaultPrevented || b.button !== 0 || b.metaKey || b.altKey || b.ctrlKey || b.shiftKey) return;
      const y = b.composedPath().find(H => H instanceof Node && H.nodeName.toUpperCase() === "A");
      if (!y || e && !y.hasAttribute("link")) return;
      const P = c(y), S = P ? y.href.baseVal : y.href;
      if ((P ? y.target.baseVal : y.target) || !S && !y.hasAttribute("state")) return;
      const _ = (y.getAttribute("rel") || "").split(/\s+/);
      if (y.hasAttribute("download") || _ && _.includes("external")) return;
      const R = P ? new URL(S, document.baseURI) : new URL(S);
      if (
        !(R.origin !== window.location.origin
          || i && R.pathname && !R.pathname.toLowerCase().startsWith(i.toLowerCase()))
      ) return [y, R];
    }
    function u(b) {
      const y = p(b);
      if (!y) return;
      const [P, S] = y, $ = o.parsePath(S.pathname + S.search + S.hash), _ = P.getAttribute("state");
      b.preventDefault(),
        s($, {
          resolve: !1,
    ...
    function h(b) {
      ...
      if (!y) return;
      const [P, S] = y;
      r && (S.pathname = r(S.pathname)), o.preloadRoute(S, P.getAttribute("preload") !== "false");
    }
    function f(b) {
      clearTimeout(a);
      const y = p(b);
      if (!y) return l = null;
      const [P, S] = y;
      l !== P && (r && (S.pathname = r(S.pathname)),
        a = setTimeout(() => {
          o.preloadRoute(S, P.getAttribute("preload") !== "false"), l = P;
        }, 20));
    }
    function g(b) {
      if (b.defaultPrevented) return;
      let y = b.submitter && b.submitter.hasAttribute("formaction")
        ? b.submitter.getAttribute("formaction")
        : b.target.getAttribute("action");
      if (!y) return;
      if (!y.startsWith("https://action/")) {
        const S = new URL(y, sr);
        if (y = o.parsePath(S.pathname + S.search), !y.startsWith(n)) return;
      }
      if (b.target.method.toUpperCase() !== "POST") throw new Error("Only POST forms are supported for Actions");
      const P = ti.get(y);
      if (P) {
        b.preventDefault();
        const S = new FormData(b.target, b.submitter);
        P.call({ r: o, f: b.target }, b.target.enctype === "multipart/form-data" ? S : new URLSearchParams(S));
      }
    }
    q(["click", "submit"]),
      ...
      document.addEventListener("submit", g),
      ne(() => {
        document.removeEventListener("click", u),
          ...
          document.removeEventListener("submit", g);
      });
  };
}
function ri(t) {
  const e = () => {
      const r = window.location.pathname.replace(/^\/+/, "/") + window.location.search,
        o = window.history.state && window.history.state._depth && Object.keys(window.history.state).length === 1
          ? void 0
  ...
  return Qo({
    get: e,
    set({ value: r, replace: o, scroll: i, state: s }) {
      o ? window.history.replaceState(Ao(s), "", r) : window.history.pushState(s, "", r),
        ei(decodeURIComponent(window.location.hash.slice(1)), i),
        bn();
    },
    init: r =>
      Zo(
    ...
    create: ni(t.preload, t.explicitLinks, t.actionBase, t.transformUrl),
    utils: { go: r => window.history.go(r), beforeLeave: n },
  })(t);
}
var oi = v("<a>");
function Je(t) {
  t = A({ inactiveClass: "inactive", activeClass: "active" }, t);
  const [, e] = x(t, ["href", "state", "class", "activeClass", "inactiveClass", "end"]),
    n = Mo(() => t.href),
    r = No(n),
    o = Ho(),
    i = M(() => {
      ...
      const a = De(s.split(/[?#]/, 1)[0]).toLowerCase(), l = decodeURI(De(o.pathname).toLowerCase());
      return [t.end ? a === l : l.startsWith(a + "/") || l === a, a === l];
    });
  return (() => {
    var s = oi();
    return I(
...
const bt = Symbol("store-raw"), Be = Symbol("store-node"), ce = Symbol("store-has"), mr = Symbol("store-self");
function hr(t) {
  let e = t[te];
  if (!e && (Object.defineProperty(t, te, { value: e = new Proxy(t, ai) }), !Array.isArray(t))) {
    const n = Object.keys(t), r = Object.getOwnPropertyDescriptors(t);
    for (let o = 0, i = n.length; o < i; o++) {
      const s = n[o];
      r[s].get && Object.defineProperty(t, s, { enumerable: r[s].enumerable, get: r[s].get.bind(e) });
    }
  }
  return e;
}
function Me(t) {
  ...
  return t != null && typeof t == "object"
    && (t[te] || !(e = Object.getPrototypeOf(t)) || e === Object.prototype || Array.isArray(t));
}
function Ne(t, e = new Set()) {
  let n, r, o, i;
  if (n = t != null && t[bt]) return n;
  if (!Me(t) || e.has(t)) return t;
  if (Array.isArray(t)) {
    Object.isFrozen(t) ? t = t.slice(0) : e.add(t);
    for (let s = 0, a = t.length; s < a; s++) o = t[s], (r = Ne(o, e)) !== o && (t[s] = r);
  } else {
    Object.isFrozen(t) ? t = Object.assign({}, t) : e.add(t);
    const s = Object.keys(t), a = Object.getOwnPropertyDescriptors(t);
    for (let l = 0, c = s.length; l < c; l++) i = s[l], !a[i].get && (o = t[i], (r = Ne(o, e)) !== o && (t[i] = r));
  }
  return t;
}
function yt(t, e) {
  let n = t[e];
  return n || Object.defineProperty(t, e, { value: n = Object.create(null) }), n;
}
function Qe(t, e, n) {
  if (t[e]) return t[e];
  const [r, o] = T(n, { equals: !1, internal: !0 });
  return r.$ = o, t[e] = r;
}
function ii(t, e) {
  const n = Reflect.getOwnPropertyDescriptor(t, e);
  return !n || n.get || !n.configurable || e === te || e === Be
    || (delete n.value, delete n.writable, n.get = () => t[te][e]),
    n;
}
function fr(t) {
  nn() && Qe(yt(t, Be), mr)();
...
function si(t) {
  return fr(t), Reflect.ownKeys(t);
}
const ai = {
  get(t, e, n) {
    if (e === bt) return t;
    if (e === te) return n;
    if (e === tn) return fr(t), n;
    const r = yt(t, Be), o = r[e];
    let i = o ? o() : t[e];
    if (e === Be || e === ce || e === "__proto__") return i;
    if (!o) {
      const s = Object.getOwnPropertyDescriptor(t, e);
      nn() && (typeof i != "function" || t.hasOwnProperty(e)) && !(s && s.get) && (i = Qe(r, e, i)());
    }
    return Me(i) ? hr(i) : i;
  },
  has(t, e) {
    return e === bt || e === te || e === tn || e === Be || e === ce || e === "__proto__"
      ? !0
      : (nn() && Qe(yt(t, ce), e)(), e in t);
  },
  set() {
    return !0;
  },
...
function He(t, e, n, r = !1) {
  if (!r && t[e] === n) return;
  const o = t[e], i = t.length;
  n === void 0
    ? (delete t[e], t[ce] && t[ce][e] && o !== void 0 && t[ce][e].$())
    : (t[e] = n, t[ce] && t[ce][e] && o === void 0 && t[ce][e].$());
  let s = yt(t, Be), a;
  if ((a = Qe(s, e, o)) && a.$(() => n), Array.isArray(t) && t.length !== i) {
    for (let l = t.length; l < i; l++) (a = s[l]) && a.$();
    (a = Qe(s, "length", i)) && a.$(t.length);
  }
  (a = s[mr]) && a.$();
}
function gr(t, e) {
...
function li(t, e) {
  if (typeof e == "function" && (e = e(t)), e = Ne(e), Array.isArray(e)) {
    if (t === e) return;
    let n = 0, r = e.length;
    for (; n < r; n++) {
      const o = e[n];
...
function Xe(t, e, n = []) {
  ...
  if (e.length > 1) {
    r = e.shift();
    const s = typeof r, a = Array.isArray(t);
    if (Array.isArray(r)) {
      for (let l = 0; l < r.length; l++) Xe(t, [r[l]].concat(e), n);
      return;
    } else if (a && s === "function") {
      for (let l = 0; l < t.length; l++) r(t[l], l) && Xe(t, [l].concat(e), n);
      return;
    } else if (a && s === "object") {
      const { from: l = 0, to: c = t.length - 1, by: p = 1 } = r;
      for (let u = l; u <= c; u += p) Xe(t, [u].concat(e), n);
      return;
    } else if (e.length > 1) {
      Xe(t[r], e, [r].concat(n));
      return;
  ...
  let i = e[0];
  typeof i == "function" && (i = i(o, n), i === o) || r === void 0 && i == null
    || (i = Ne(i), r === void 0 || Me(o) && Me(i) && !Array.isArray(i) ? gr(o, i) : He(t, r, i));
}
function ci(...[t, e]) {
  const n = Ne(t || {}), r = Array.isArray(n), o = hr(n);
  function i(...s) {
    Yn(() => {
      r && s.length === 1 ? li(n, s[0]) : Xe(n, s);
    });
  }
  return [o, i];
}
const vt = new WeakMap(),
  br = {
    get(t, e) {
      ...
      const n = t[e];
      let r;
      return Me(n) ? vt.get(n) || (vt.set(n, r = new Proxy(n, br)), r) : n;
    },
    set(t, e, n) {
      return He(t, e, Ne(n)), !0;
    },
    deleteProperty(t, e) {
      return He(t, e, void 0, !0), !0;
    },
  };
function Gt(t) {
  return e => {
    if (Me(e)) {
      let n;
      (n = vt.get(e)) || vt.set(e, n = new Proxy(e, br)), t(n);
    }
    return e;
  };
}
...
var di = v("<span class=so-button__spinner aria-hidden=true>"),
  Tn = v("<span class=so-button__icon aria-hidden=true>"),
  ui = v("<button>");
function z(t) {
  const [e, n] = x(t, ["class", "variant", "size", "disabled", "iconLeft", "iconRight", "loading", "children"]);
  return (() => {
    var r = ui();
    return I(
      r,
      A({
        get class() {
          return C(
            "so-button",
            `so-button--${e.variant ?? "neutral"}`,
            `so-button--${e.size ?? "md"}`,
            e.loading && "so-button--loading",
            e.class,
          );
        },
        get disabled() {
...
var bi = v(
  "<div class=site><header class=site-header><nav class=site-nav></nav><div class=site-controls><select class=lang-select><option value=en>EN</option><option value=ja>JA</option></select><a href=https://github.com/misebox/soluid target=_blank rel=\"noopener noreferrer\"class=github-link aria-label=GitHub><svg width=20 height=20 viewBox=\"0 0 24 24\"fill=currentColor><path d=\"M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0024 12c0-6.63-5.37-12-12-12z\"></path></svg></a></div></header><main class=site-main>",
);
function yi(t) {
  const [e, n] = T("normal"), [r, o] = T("light");
  return se(() => {
    document.documentElement.setAttribute("data-theme", r()),
      document.documentElement.setAttribute("data-density", e()),
    ...
    (() => {
      var i = bi(),
        ...
        p = c.nextSibling,
        u = s.nextSibling;
      return m(s, d(Je, { href: "/", class: "site-logo", children: "soluid" }), a),
        m(
          a,
          d(Je, {
        ...
        m(
          ...
          d(z, {
            get variant() {
              return e() === "normal" ? "primary" : "neutral";
            },
            size: "sm",
            onClick: () => n("normal"),
            children: "Normal",
        ...
        m(
          ...
          d(z, {
            get variant() {
              return e() === "dense" ? "primary" : "neutral";
            },
            size: "sm",
            onClick: () => n("dense"),
            children: "Dense",
        ...
        c.addEventListener("change", h => mi(h.currentTarget.value)),
        m(
          l,
          d(z, {
            get variant() {
              return r() === "light" ? "primary" : "neutral";
            },
            size: "sm",
            onClick: () => o("light"),
            children: "Light",
...
var vi = v(
  ...
  Pi = v("<div class=top-category-card><h3></h3><p>");
const Si = [
  ...
  return (() => {
    ...
    return m(r, () => B(E(), "top.heroSub")),
      ...
      m(P, () =>
        Si.map(_ =>
          (() => {
            var R = Pi(), H = R.firstChild, le = H.nextSibling;
...
var Dt = v("<div>");
function Pt(t) {
  const [e, n] = x(t, ["class", "density", "variant", "children"]);
  return (() => {
    var r = Dt();
    return I(
      r,
      A({
        get class() {
          return C("so-card", e.variant === "elevated" && "so-card--elevated", e.class);
        },
        get "data-density"() {
          return e.density;
        },
...
function St(t) {
  ...
  return (() => {
    ...
    return I(
      ...
      A({
        get class() {
          return C("so-card__header", e.class);
        },
      }, n),
      !1,
      !0,
...
function wt(t) {
  ...
  return (() => {
    ...
    return I(
      ...
      A({
        get class() {
          return C("so-card__body", e.class);
        },
      }, n),
      !1,
      !0,
...
function xi(t) {
  ...
  return (() => {
    ...
    return I(
      ...
      A({
        get class() {
          return C("so-card__footer", e.class);
        },
      }, n),
      !1,
      !0,
...
var ki = v("<legend class=so-radio-group__label>"),
  Di = v("<p class=so-radio-group__error role=alert>"),
  Ai = v("<p class=so-radio-group__hint>"),
  Ti = v("<fieldset role=radiogroup><div class=so-radio-group__items>");
function Pr(t) {
...
var Ii = v("<span class=so-radio-button__label>"),
  Ei = v(
    ...
    return a.nextSibling,
      ...
      D(l => {
        var c = C("so-radio-button", e.disabled && "so-radio-button--disabled", e.class),
          ...
          u = e.disabled;
        return c !== l.e && G(s, l.e = c), p !== l.t && w(a, "name", l.t = p), u !== l.a && (a.disabled = l.a = u), l;
...
var Bi = v("<div class=code-wrapper><pre class=gs-code><code></code></pre><button class=copy-btn>"),
  _e = v("<p>"),
  Ri = v("<code>"),
  Oi = v("<h1>"),
  Li = v(
  ...
  Fi = v("<div class=gs-page>");
function ge(t) {
  const [e, n] = T(!1);
  function r() {
    navigator.clipboard.writeText(t.children), n(!0), setTimeout(() => n(!1), 1500);
  }
  return (() => {
    var o = Bi(), i = o.firstChild, s = i.firstChild, a = i.nextSibling;
    return m(s, () => t.children), a.$$click = r, m(a, () => e() ? "Copied" : "Copy"), o;
  })();
}
function xe(t) {
  return d(Pt, {
...
function Mi() {
  const [t, e] = T("bunx"), n = r => `${t()} soluid ${r}`;
  return (() => {
    var r = Fi();
    return m(
      r,
              ...
              d(xe, {
                ...
                get children() {
                  return [
                    ...
                    d(ge, { children: zi }),
                    (() => {
                      var o = Li(), i = o.firstChild, s = i.firstChild;
                      s.nextSibling;
                      var a = i.nextSibling, l = a.firstChild;
                      l.nextSibling;
                      var c = a.nextSibling, p = c.firstChild;
                      return p.nextSibling,
                        m(i, () => B(E(), "gs.step2.componentDir"), null),
...
var Gi = v("<div>"),
  Ki = v("<div role=tablist aria-orientation=horizontal>"),
  qi = v("<button type=button role=tab>"),
  ji = v("<div role=tabpanel>");
const Sr = Se();
function wr() {
  const t = me(Sr);
...
function Cr(t) {
  const [e, n] = x(t, ["class", "density", "value", "onChange", "children"]),
    r = `so-tabs-${ue()}`,
    o = { value: () => e.value, onChange: i => e.onChange(i), baseId: r };
...
function $r(t) {
  const [e, n] = x(t, ["class", "children"]);
  function r(o) {
    const i = o.currentTarget, s = Array.from(i.querySelectorAll("[role=\"tab\"]:not(:disabled)"));
    if (s.length === 0) return;
    const a = document.activeElement, l = s.indexOf(a);
    if (l === -1) return;
    let c;
    o.key === "ArrowRight"
      ? c = (l + 1) % s.length
      : o.key === "ArrowLeft"
      ? c = (l - 1 + s.length) % s.length
      : o.key === "Home"
      ? c = 0
      : o.key === "End" && (c = s.length - 1), c != null && (o.preventDefault(), s[c].focus(), s[c].click());
  }
  return (() => {
    var o = Ki();
    return o.$$keydown = r,
  ...
  return (() => {
    ...
    return o.$$click = () => {
      ...
      I(
        ...
        A({
          get class() {
            return C("so-tab", r.value() === e.value && "so-tab--active", e.class);
          },
          get id() {
            return `${r.baseId}-tab-${e.value}`;
          },
          get "aria-selected"() {
            return r.value() === e.value;
          },
          get "aria-controls"() {
            return `${r.baseId}-panel-${e.value}`;
          },
          get disabled() {
            return e.disabled;
          },
          get tabIndex() {
            return r.value() === e.value ? 0 : -1;
          },
        }, n),
        !1,
        !0,
...
function qt(t) {
  ...
  return (() => {
    var r = Xi(), o = r.firstChild, i = o.firstChild, s = o.nextSibling;
    return I(
      r,
      A({
        get class() {
          return C("so-accordion-item", e.disabled && "so-accordion-item--disabled", e.class);
        },
        get open() {
          return e.open;
        },
...
q(["click"]);
var Ui = v("<img class=so-avatar__img>"),
  Wi = v("<span class=so-avatar__initials aria-hidden=true>"),
  Yi = v(
...
function lt(t) {
  ...
  return (() => {
    ...
    return I(
      ...
      A({
        get class() {
          return C("so-avatar", `so-avatar--${e.size ?? "md"}`, `so-avatar--${e.variant ?? "neutral"}`, e.class);
        },
        get "aria-label"() {
          return e.alt ?? e.name;
        },
          ...
          get children() {
            ...
            return l.addEventListener("error", () => o(!0)),
              D(c => {
                ...
                return p !== c.e && w(l, "src", c.e = p), u !== c.t && w(l, "alt", c.t = u), c;
              }, { e: void 0, t: void 0 }),
              l;
          },
        }),
...
var ts = v("<legend class=so-checkbox-group__label>"),
  ns = v("<p class=so-checkbox-group__error role=alert>"),
  rs = v("<p class=so-checkbox-group__hint>"),
  os = v("<fieldset role=group><div class=so-checkbox-group__items>");
function is(t) {
  const [e, n] = x(t, ["class", "value", "onChange", "label", "error", "hint", "children"]),
    ...
    a = {
      ...
      onChange(l, c) {
        var h;
        const p = e.value ?? [], u = c ? [...p, l] : p.filter(f => f !== l);
  ...
  return d(xr.Provider, {
    value: a,
    get children() {
      var l = os(), c = l.firstChild;
      return I(
        l,
        A({
          get class() {
            return C("so-checkbox-group", e.error && "so-checkbox-group--error", e.class);
          },
          get "aria-invalid"() {
            return e.error ? !0 : void 0;
          },
...
var ss = v("<dl>"), as = v("<dt class=so-description-list__term>"), ls = v("<dd class=so-description-list__detail>");
function _r(t) {
  ...
  return (() => {
    ...
    return I(
      ...
      A({
        get class() {
          return C("so-description-list", (e.columns ?? 1) === 2 && "so-description-list--2col", e.class);
        },
        get "data-density"() {
          return e.density;
        },
...
function ln(t, e, n, r) {
  return t.addEventListener(e, n, r), cs(t.removeEventListener.bind(t, e, n, r));
}
...
function In(t) {
  return Array.from(t.querySelectorAll(ms));
}
function Dr(t) {
  const e = ps();
  let n = null;
  ...
  function o(i) {
    ...
    const l = a[0], c = a[a.length - 1], p = document.activeElement;
    i.shiftKey && p === l ? (i.preventDefault(), c.focus()) : !i.shiftKey && p === c && (i.preventDefault(), l.focus());
  }
  ln(document, "keydown", o),
    ne(() => {
      n && n instanceof HTMLElement && n.focus();
    });
}
var hs = v("<div><div role=dialog aria-modal=true>"), fs = v("<div>");
let En = 0;
const Ar = Se();
function gs(t) {
  const [e, n] = x(t, ["class", "density", "open", "onClose", "side", "size", "children"]);
  En += 1;
  const r = `so-drawer-title-${En}`, [o, i] = T(!1), [s, a] = T(!1);
  se(Te(() => e.open, h => {
    h ? (a(!1), i(!0)) : o() && a(!0);
  }));
  function l() {
          ...
          return d(Ar.Provider, {
            ...
            get children() {
              ...
              return h.addEventListener("animationend", l),
                ...
                m(f, () => e.children),
                D(() => G(h, C("so-drawer-backdrop", s() && "so-drawer-backdrop--closing"))),
                h;
            },
          });
        },
  ...
  return (() => {
    ...
    return w(o, "id", r),
      I(
        ...
        A({
          get class() {
            return C("so-drawer__header", e.class);
          },
        }, n),
        !1,
        !0,
...
q(["click"]);
var ys = v("<div class=so-empty-state__icon>"),
  vs = v("<p class=so-empty-state__description>"),
  Ps = v("<div class=so-empty-state__action>"),
  Ss = v("<div><h3 class=so-empty-state__title>");
function ws(t) {
  const [e, n] = x(t, ["class", "density", "title", "description", "icon", "action"]);
  return (() => {
    var r = Ss(), o = r.firstChild;
    return I(
      r,
      A({
        get class() {
          return C("so-empty-state", e.class);
        },
        get "data-density"() {
          return e.density;
        },
...
function _s(t, e, n) {
  n === void 0 && (n = !1);
  const r = Tt(t), o = Er(t), i = Ir(o);
  let s = o === "x" ? r === (n ? "end" : "start") ? "right" : "left" : r === "start" ? "bottom" : "top";
  return e.reference[i] > e.floating[i] && (s = $t(s)), [s, $t(s)];
}
function ks(t) {
  const e = $t(t);
  return [dn(t), e, dn(e)];
...
function dn(t) {
  return t.replace(/start|end/g, e => $s[e]);
}
const Rn = ["left", "right"], On = ["right", "left"], Ds = ["top", "bottom"], As = ["bottom", "top"];
function Ts(t, e, n) {
  switch (t) {
    case "top":
    case "bottom":
...
function Is(t, e, n, r) {
  const o = Tt(t);
  let i = Ts(Ae(t), n === "start", r);
  return o && (i = i.map(s => s + "-" + o), e && (i = i.concat(i.map(dn)))), i;
}
function $t(t) {
  return t.replace(/left|right|bottom|top/g, e => Cs[e]);
}
function Es(t) {
  return { top: 0, right: 0, bottom: 0, left: 0, ...t };
}
function Bs(t) {
  return typeof t != "number" ? Es(t) : { top: t, right: t, bottom: t, left: t };
}
function xt(t) {
...
async function Rs(t, e) {
  ...
  const { x: r, y: o, platform: i, rects: s, elements: a, strategy: l } = t,
    ...
    P = xt(
      await i.getClippingRect({
        element: (n = await (i.isElement == null ? void 0 : i.isElement(y))) == null || n
          ? y
          : y.contextElement || await (i.getDocumentElement == null ? void 0 : i.getDocumentElement(a.floating)),
        boundary: c,
        rootBoundary: p,
        strategy: l,
      }),
    ),
    S = u === "floating" ? { x: r, y: o, width: s.floating.width, height: s.floating.height } : s.reference,
    $ = await (i.getOffsetParent == null ? void 0 : i.getOffsetParent(a.floating)),
    _ = await (i.isElement == null ? void 0 : i.isElement($))
  ...
  return {
    top: (P.top - R.top + g.top) / _.y,
    bottom: (R.bottom - P.bottom + g.bottom) / _.y,
    left: (P.left - R.left + g.left) / _.x,
    right: (R.right - P.right + g.right) / _.x,
  };
}
const Os = async (t, e, n) => {
    ...
    for (let y = 0; y < a.length; y++) {
      var b;
      const { name: P, fn: S } = a[y],
        { x: $, y: _, data: R, reset: H } = await S({
          x: p,
          y: u,
          initialPlacement: r,
          placement: h,
          ...
          middlewareData: f,
          rects: c,
          platform: { ...s, detectOverflow: (b = s.detectOverflow) != null ? b : Rs },
      ...
      p = $ ?? p,
        ...
        f = { ...f, [P]: { ...f[P], ...R } },
        H && g <= 50 && (g++,
          typeof H == "object" && (H.placement && (h = H.placement),
            H.rects && (c = H.rects === !0
  ...
  Ls = function(t) {
    return t === void 0 && (t = {}), {
      ...
      async fn(e) {
        var n, r;
        const { placement: o, middlewareData: i, rects: s, initialPlacement: a, platform: l, elements: c } = e,
          {
            mainAxis: p = !0,
            crossAxis: u = !0,
        ...
        const P = Ae(o),
          ...
          R = h || ($ || !b ? [$t(a)] : ks(a)),
          H = g !== "none";
        !h && H && R.push(...Is(a, b, g, _));
        const le = [a, ...R], qe = await l.detectOverflow(e, y), $e = [];
        let fe = ((r = i.flip) == null ? void 0 : r.overflows) || [];
        if (p && $e.push(qe[P]), u) {
          const O = _s(o, s, _);
        ...
        if (fe = [...fe, { placement: o, overflows: $e }], !$e.every(O => O <= 0)) {
          var rt, ot;
          const O = (((rt = i.flip) == null ? void 0 : rt.index) || 0) + 1, F = le[O];
          if (
            F
            && (!(u === "alignment" ? S !== be(F) : !1)
              || fe.every(V => be(V.placement) === S ? V.overflows[0] > 0 : !0))
          ) return { data: { index: O, overflows: fe }, reset: { placement: F } };
          let K = (ot = fe.filter(W => W.overflows[0] <= 0).sort((W, V) => W.overflows[1] - V.overflows[1])[0]) == null
            ? void 0
            : ot.placement;
          if (!K) {
            switch (f) {
              case "bestFit": {
                var it;
                const W = (it = fe.filter(V => {
                    if (H) {
                      const X = be(V.placement);
                      return X === S || X === "y";
                    }
                    return !0;
                  }).map(V => [V.placement, V.overflows.filter(X => X > 0).reduce((X, je) => X + je, 0)]).sort((
                    V,
                    X,
                  ) => V[1] - X[1])[0]) == null
                  ? void 0
...
const Ms = function(t) {
    return t === void 0 && (t = 0), {
      ...
      async fn(e) {
        var n, r;
        const { x: o, y: i, placement: s, middlewareData: a } = e, l = await zs(e, t);
  ...
  Ns = function(t) {
    return t === void 0 && (t = {}), {
      ...
      async fn(e) {
        ...
        return { ...y, data: { x: y.x - n, y: y.y - r, enabled: { [f]: s, [h]: a } } };
      },
    };
  };
function It() {
...
function Br(t) {
  return It() ? t instanceof Node || t instanceof Q(t).Node : !1;
}
function re(t) {
  return It() ? t instanceof Element || t instanceof Q(t).Element : !1;
}
function ae(t) {
...
const Hs = new Set(["inline", "contents"]);
function nt(t) {
  const { overflow: e, overflowX: n, overflowY: r, display: o } = oe(t);
  return /auto|scroll|overlay|hidden|clip/.test(e + r + n) && !Hs.has(o);
}
...
const js = ["transform", "translate", "scale", "rotate", "perspective"],
  Vs = ["transform", "translate", "scale", "rotate", "perspective", "filter"],
  Xs = ["paint", "layout", "strict", "content"];
function Pn(t) {
  const e = Sn(), n = re(t) ? oe(t) : t;
  return js.some(r => n[r] ? n[r] !== "none" : !1) || (n.containerType ? n.containerType !== "normal" : !1)
    || !e && (n.backdropFilter ? n.backdropFilter !== "none" : !1) || !e && (n.filter ? n.filter !== "none" : !1)
    || Vs.some(r => (n.willChange || "").includes(r)) || Xs.some(r => (n.contain || "").includes(r));
}
function Js(t) {
  let e = ve(t);
  for (; ae(e) && !Ge(e);) {
...
const Us = new Set(["html", "body", "#document"]);
function Ge(t) {
  return Us.has(Ke(t));
}
function oe(t) {
...
function Bt(t) {
  return re(t) ? { scrollLeft: t.scrollLeft, scrollTop: t.scrollTop } : { scrollLeft: t.scrollX, scrollTop: t.scrollY };
}
function ve(t) {
...
function Rr(t) {
  const e = ve(t);
  return Ge(e) ? t.ownerDocument ? t.ownerDocument.body : t.body : ae(e) && nt(e) ? e : Rr(e);
}
function Or(t, e, n) {
  var r;
  e === void 0 && (e = []);
  const o = Rr(t), i = o === ((r = t.ownerDocument) == null ? void 0 : r.body), s = Q(o);
  return i ? (un(s), e.concat(s, s.visualViewport || [], nt(o) ? o : [], [])) : e.concat(o, Or(o, []));
}
function un(t) {
...
function Lr(t) {
  ...
  const o = ae(t), i = o ? t.offsetWidth : n, s = o ? t.offsetHeight : r, a = Ct(n) !== i || Ct(r) !== s;
...
function Fe(t) {
  const e = Fr(t);
  if (!ae(e)) return ie(1);
  const n = e.getBoundingClientRect(), { width: r, height: o, $: i } = Lr(e);
  let s = (i ? Ct(n.width) : n.width) / r, a = (i ? Ct(n.height) : n.height) / o;
  return (!s || !Number.isFinite(s)) && (s = 1), (!a || !Number.isFinite(a)) && (a = 1), { x: s, y: a };
}
const Ws = ie(0);
function zr(t) {
  const e = Q(t);
  return !Sn() || !e.visualViewport ? Ws : { x: e.visualViewport.offsetLeft, y: e.visualViewport.offsetTop };
}
function Ys(t, e, n) {
...
function Ze(t, e, n, r) {
  ...
  const o = t.getBoundingClientRect(), i = Fr(t);
  let s = ie(1);
  e && (r ? re(r) && (s = Fe(r)) : s = Fe(t));
  const a = Ys(i, n, r) ? zr(i) : ie(0);
  let l = (o.left + a.x) / s.x, c = (o.top + a.y) / s.y, p = o.width / s.x, u = o.height / s.y;
  if (i) {
    const h = Q(i), f = r && re(r) ? Q(r) : r;
    let g = h, b = un(g);
    for (; b && r && f !== g;) {
      const y = Fe(b),
        ...
        _ = P.top + (b.clientTop + parseFloat(S.paddingTop)) * y.y;
      l *= y.x, c *= y.y, p *= y.x, u *= y.y, l += $, c += _, g = Q(b), b = un(g);
    }
  }
  return xt({ width: p, height: u, x: l, y: c });
}
function Rt(t, e) {
  const n = Bt(t).scrollLeft;
  return e ? e.left + n : Ze(he(t)).left + n;
}
function Mr(t, e) {
...
function Qs(t) {
  ...
  const i = o === "fixed", s = he(r), a = e ? Et(e.floating) : !1;
  if (r === s || a && i) return n;
  let l = { scrollLeft: 0, scrollTop: 0 }, c = ie(1);
  const p = ie(0), u = ae(r);
  if ((u || !u && !i) && ((Ke(r) !== "body" || nt(s)) && (l = Bt(r)), ae(r))) {
    const f = Ze(r);
    c = Fe(r), p.x = f.x + r.clientLeft, p.y = f.y + r.clientTop;
  }
  const h = s && !u && !i ? Mr(s, l) : ie(0);
  return {
    width: n.width * c.x,
    height: n.height * c.y,
    x: n.x * c.x - l.scrollLeft * c.x + p.x + h.x,
...
function ea(t) {
  const e = he(t),
    ...
    i = Le(e.scrollHeight, e.clientHeight, r.scrollHeight, r.clientHeight);
  let s = -n.scrollLeft + Rt(t);
  const a = -n.scrollTop;
  return oe(r).direction === "rtl" && (s += Le(e.clientWidth, r.clientWidth) - o), { width: o, height: i, x: s, y: a };
}
const zn = 25;
function ta(t, e) {
...
function oa(t, e) {
  ...
  for (; re(s) && !Ge(s);) {
    ...
    !l && a.position === "fixed" && (o = null),
      (i ? !l && !o : !l && a.position === "static" && !!o && na.has(o.position) || nt(s) && !l && Nr(t, s))
        ? r = r.filter(p => p !== s)
        : o = a,
      s = ve(s);
  }
...
function ia(t) {
  ...
  const s = [...n === "clippingAncestors" ? Et(e) ? [] : oa(e, this._c) : [].concat(n), r],
    a = s[0],
    l = s.reduce((c, p) => {
      const u = Mn(e, p, o);
...
function aa(t, e, n) {
  const r = ae(e), o = he(e), i = n === "fixed", s = Ze(t, !0, i, e);
  ...
  if (r || !r && !i) {
    if ((Ke(e) !== "body" || nt(o)) && (a = Bt(e)), r) {
      const f = Ze(e, !0, i, e);
      l.x = f.x + e.clientLeft, l.y = f.y + e.clientTop;
    } else o && c();
  }
  i && !r && o && c();
  const p = o && !r && !i ? Mr(o, a) : ie(0),
    u = s.left + a.scrollLeft - l.x - p.x,
    h = s.top + a.scrollTop - l.y - p.y;
...
function Hr(t, e) {
  ...
  let r = Nn(t, e);
  for (; r && Ks(r) && jt(r);) r = Nn(r, e);
  return r && Ge(r) && jt(r) && !Pn(r) ? n : r || Js(t) || n;
}
...
const da = {
  ...
  qr = Ls,
  jr = (t, e, n) => {
    const r = new Map(), o = { platform: da, ...n }, i = { ...o.platform, _c: r };
    return Os(t, e, { ...o, platform: i });
  };
...
function fa(t) {
  ...
  function a() {
    const h = i();
    !o || !h
      || jr(o, h, { placement: e.placement ?? "bottom-start", middleware: [Gr(4), qr(), Kr({ padding: 8 })] }).then(
        ({ x: f, y: g }) => {
          h.style.left = `${f}px`, h.style.top = `${g}px`;
        },
      );
  }
  se(Te(() => e.open, h => {
  ...
  function c(h) {
    if (!e.open) return;
    if (h.key === "Escape") {
      h.stopPropagation(), e.onOpenChange(!1), o == null || o.focus();
      return;
    }
    const f = i();
    if (!f) return;
    ...
    if (h.key === "ArrowDown") {
      h.preventDefault();
      const P = y < g.length - 1 ? y + 1 : 0;
      g[P].focus();
    } else if (h.key === "ArrowUp") {
      h.preventDefault();
      const P = y > 0 ? y - 1 : g.length - 1;
      g[P].focus();
    } else {h.key === "Home"
        ? (h.preventDefault(), g[0].focus())
        : h.key === "End" && (h.preventDefault(), g[g.length - 1].focus());}
  }
  function p(h) {
    if (!e.open) return;
    const f = i(), g = h.target;
    o != null && o.contains(g) || f != null && f.contains(g) || e.onOpenChange(!1);
  }
  se(() => {
    e.open
      ? (document.addEventListener("mousedown", p), document.addEventListener("keydown", c))
  ...
  return (() => {
    ...
    I(
      ...
      A({
        get class() {
          return C("so-menu-anchor", e.class);
        },
        get "data-density"() {
          return e.density;
        },
    ...
    var g = o;
    return typeof g == "function" ? ye(g, f) : o = f,
      m(f, () => e.trigger),
      m(
        h,
        d(k, {
          ...
          get children() {
            return d(tt, {
              get children() {
                var b = ua();
                return ye(s, b), w(b, "id", r), m(b, () => e.children), b;
              },
            });
          },
        }),
      ...
      D(b => {
        var y = e.open, P = e.open ? r : void 0;
        return y !== b.e && w(f, "aria-expanded", b.e = y), P !== b.t && w(f, "aria-controls", b.t = P), b;
      }, { e: void 0, t: void 0 }),
      h;
  })();
}
function Vt(t) {
  ...
  function r() {
    var i;
    e.disabled || (i = e.onSelect) == null || i.call(e);
  }
  function o(i) {
    var s;
    (i.key === "Enter" || i.key === " ") && !e.disabled && (i.preventDefault(), (s = e.onSelect) == null || s.call(e));
  }
  return (() => {
    var i = ma();
    return i.$$keydown = o,
      ...
      I(
        ...
        A({
          get class() {
            return C("so-menu-item", e.disabled && "so-menu-item--disabled", e.class);
          },
          get tabIndex() {
...
function ga(t) {
  ...
  return (() => {
    ...
    return I(
      ...
      A({
        get class() {
          return C("so-menu-separator", e.class);
        },
      }, n),
      !1,
      !1,
        ...
        d(k, {
          ...
          get children() {
            return d(tt, {
              get children() {
                var g = ba();
                return ye(s, g), w(g, "id", r), m(g, () => e.content), g;
              },
            });
          },
        }),
      ...
      m(
        ...
        d(k, {
          ...
          get children() {
            ...
            return g.addEventListener("change", s), D(() => g.checked = i()), f;
          },
        }),
        null,
      ),
...
const Aa = (t, e) => {
    ...
    return kt() && ne(r),
      Object.assign((...i) => {
        n !== void 0 && r(), n = setTimeout(() => t(...i), e);
      }, { clear: r });
  },
  Ta = 150;
let Gn = 0;
function Ia(t = {}) {
  const e = t.defaultDuration ?? 5e3, [n, r] = ci([]), o = new Map();
  function i(l) {
    r(Gt(c => {
  ...
  return { toasts: n, add: a, dismiss: s };
}
    ...
    get children() {
      ...
      return m(
        ...
        d(Y, {
          ...
          children: o =>
            (() => {
              var i = Ba(), s = i.firstChild, a = s.nextSibling;
              return m(s, () => o.message),
                ...
                D(l => {
                  ...
                  return c !== l.e && G(i, l.e = c), p !== l.t && w(i, "role", l.t = p), l;
                }, { e: void 0, t: void 0 }),
                i;
            })(),
        }),
...
function ct(t) {
  ...
  return d(k, {
    ...
    get children() {
      var o = La(), i = o.firstChild, s = i.nextSibling;
      return I(
        o,
        A({
          get class() {
        ...
        w(i, "aria-describedby", r),
        m(i, () => e.children),
        w(s, "id", r),
        m(s, () => e.content),
        D(() => G(s, C("so-tooltip", `so-tooltip--${e.placement ?? "top"}`))),
        o;
    },
  });
}
      ...
      m(
        ...
        d(k, {
          ...
          get children() {
            ...
            return i.$$click = () => {
              var s;
              return (s = e.onDismiss) == null ? void 0 : s.call(e);
            },
              i;
          },
        }),
...
function Na(t) {
  ...
  qn += 1;
  const r = `so-dialog-title-${qn}`, [o, i] = T(!1), [s, a] = T(!1);
  se(Te(() => e.open, h => {
    h ? (a(!1), i(!0)) : o() && a(!0);
  }));
  function l() {
            ...
            get children() {
              ...
              return h.addEventListener("animationend", l),
                ...
                I(
                  ...
                  A({
                    get class() {
                      return C("so-dialog", `so-dialog--${e.size ?? "md"}`, s() && "so-dialog--closing", e.class);
                    },
                    get "data-density"() {
                      return e.density;
                    },
                ...
                m(f, () => e.children),
                D(() => G(h, C("so-dialog-backdrop", s() && "so-dialog-backdrop--closing"))),
                h;
            },
          });
        },
  ...
  return d(Jr.Provider, {
    ...
    get children() {
      ...
      return I(
        ...
        A({
          get class() {
            return C("so-form-field", e.error && "so-form-field--error", e.class);
          },
        }, n),
        !1,
        !0,
...
function rl(t) {
  ...
  function o(l) {
    let c = l;
    return e.min != null && c < e.min && (c = e.min), e.max != null && c > e.max && (c = e.max), c;
  }
  function i() {
    var p;
    const l = e.value ?? 0, c = o(l + r());
    (p = e.onInput) == null || p.call(e, c);
  }
  function s() {
    var p;
    const l = e.value ?? 0, c = o(l - r());
  ...
  const a = l => {
    var p;
    const c = parseFloat(l.currentTarget.value);
  ...
  return (() => {
    ...
    return c.$$click = s,
      ...
      u.$$click = i,
      D(h => {
        var f = C("so-number-input", `so-number-input--${e.size ?? "md"}`),
          g = e.disabled,
          b = n == null ? void 0 : n.id,
          y = e.min,
          P = e.max,
          S = e.step,
          $ = e.disabled,
          _ = e.required,
          R = (n == null ? void 0 : n.hasError) || void 0,
          H = n != null && n.hasError ? n.errorId : n == null ? void 0 : n.hintId,
          le = e.disabled;
        return f !== h.e && G(l, h.e = f),
          g !== h.t && (c.disabled = h.t = g),
          b !== h.a && w(p, "id", h.a = b),
          y !== h.o && w(p, "min", h.o = y),
          P !== h.i && w(p, "max", h.i = P),
          S !== h.n && w(p, "step", h.n = S),
          $ !== h.s && (p.disabled = h.s = $),
          _ !== h.h && (p.required = h.h = _),
          R !== h.r && w(p, "aria-invalid", h.r = R),
          H !== h.d && w(p, "aria-describedby", h.d = H),
          le !== h.l && (u.disabled = h.l = le),
          h;
      }, {
        e: void 0,
        t: void 0,
...
function ll(t) {
  const [e] = x(t, ["value", "onChange", "options", "placeholder", "disabled", "required", "size"]),
    ...
    r = o => {
      var i;
      (i = e.onChange) == null || i.call(e, o.currentTarget.value);
    };
  return (() => {
    var o = il(), i = o.firstChild;
    return i.addEventListener("change", r),
      m(
        i,
        (() => {
          var s = U(() => !!e.placeholder);
          return () =>
            s() && (() => {
              var a = sl();
      ...
      m(
        ...
        d(Y, {
          ...
          children: s =>
            (() => {
              var a = al();
              return m(a, () => s.label), D(() => a.disabled = s.disabled), D(() => a.value = s.value), a;
            })(),
        }),
        null,
      ),
      D(s => {
        var a = n == null ? void 0 : n.id,
          l = C("so-select__input", `so-select__input--${e.size ?? "md"}`),
          c = e.disabled,
          p = e.required,
          u = (n == null ? void 0 : n.hasError) || void 0,
          h = n != null && n.hasError ? n.errorId : n == null ? void 0 : n.hintId;
        return a !== s.e && w(i, "id", s.e = a),
          l !== s.t && G(i, s.t = l),
          c !== s.a && (i.disabled = s.a = c),
          p !== s.o && (i.required = s.o = p),
          u !== s.i && w(i, "aria-invalid", s.i = u),
          h !== s.n && w(i, "aria-describedby", s.n = h),
          s;
...
function dl(t = {}) {
  const [e, n] = T(t.defaultPressed ?? !1), r = t.pressed ?? e;
  function o(s) {
    var a;
    t.pressed || n(s), (a = t.onPressedChange) == null || a.call(t, s);
  }
  function i() {
    o(!r());
  }
  return { pressed: r, toggle: i, setPressed: o, props: { "aria-pressed": r, onClick: i } };
}
...
function jn(t) {
  const [e, n] = x(t, ["class", "checked", "onChange", "disabled", "size", "label", "error", "hint", "children"]),
    ...
    c = u => {
      (u.key === " " || u.key === "Enter") && (u.preventDefault(), e.disabled || a.toggle());
    },
    p = () => {
      if (e.error) return o;
      if (e.hint) return i;
    ...
    return f.$$keydown = c,
      ...
      m(
        ...
        d(k, {
          ...
          get children() {
            var g = ml();
            return w(g, "id", i), m(g, () => e.hint), g;
          },
        }),
        null,
      ),
      D(g => {
        var b = C("so-switch-wrapper", e.error && "so-switch-wrapper--error"),
          y = C("so-switch", `so-switch--${e.size ?? "md"}`, e.disabled && "so-switch--disabled", e.class),
          P = a.pressed(),
          S = e.error ? !0 : void 0,
          $ = p(),
          _ = e.disabled;
        return b !== g.e && G(u, g.e = b),
          y !== g.t && G(h, g.t = y),
          P !== g.a && w(f, "aria-checked", g.a = P),
          S !== g.o && w(f, "aria-invalid", g.o = S),
          $ !== g.i && w(f, "aria-describedby", g.i = $),
          _ !== g.n && (f.disabled = g.n = _),
          g;
      }, { e: void 0, t: void 0, a: void 0, o: void 0, i: void 0, n: void 0 }),
      u;
  })();
...
function gl(t) {
  const [e] = x(t, ["value", "onInput", "placeholder", "rows", "disabled", "required", "size"]),
    ...
    r = o => {
      var i;
      (i = e.onInput) == null || i.call(e, o.currentTarget.value);
    };
  return (() => {
    var o = fl();
    return o.$$input = r,
      D(i => {
        var s = n == null ? void 0 : n.id,
          a = C("so-textarea__input", `so-textarea__input--${e.size ?? "md"}`),
          l = e.placeholder,
          c = e.rows ?? 3,
          p = e.disabled,
          u = e.required,
          h = (n == null ? void 0 : n.hasError) || void 0,
          f = n != null && n.hasError ? n.errorId : n == null ? void 0 : n.hintId;
        return s !== i.e && w(o, "id", i.e = s),
          a !== i.t && G(o, i.t = a),
          l !== i.a && w(o, "placeholder", i.a = l),
          c !== i.o && w(o, "rows", i.o = c),
          p !== i.i && (o.disabled = i.i = p),
          u !== i.n && (o.required = i.n = u),
          h !== i.s && w(o, "aria-invalid", i.s = h),
          f !== i.h && w(o, "aria-describedby", i.h = f),
          i;
...
function vl(t) {
  ...
  return (() => {
    ...
    return o.$$input = r,
      D(i => {
        var s = n == null ? void 0 : n.id,
          a = C("so-text-field__input", `so-text-field__input--${e.size ?? "md"}`),
          l = e.type ?? "text",
          c = e.placeholder,
          p = e.disabled,
          u = e.required,
        ...
        return s !== i.e && w(o, "id", i.e = s),
          a !== i.t && G(o, i.t = a),
          l !== i.a && w(o, "type", i.a = l),
          c !== i.o && w(o, "placeholder", i.o = c),
          p !== i.i && (o.disabled = i.i = p),
          u !== i.n && (o.required = i.n = u),
          h !== i.s && w(o, "aria-invalid", i.s = h),
          f !== i.h && w(o, "aria-describedby", i.h = f),
...
function Bl(t, e, n) {
  ...
  let i = Math.max(2, t - r), s = Math.min(e - 1, t + r);
  t <= r + 2 && (s = Math.min(e - 1, n - 2)),
    t >= e - r - 1 && (i = Math.max(2, e - n + 3)),
    i > 2 && o.push("ellipsis");
  for (let a = i; a <= s; a++) o.push(a);
  return s < e - 1 && o.push("ellipsis"), o.push(e), o;
}
function Vn(t) {
  const [e, n] = x(t, ["class", "density", "page", "totalPages", "onChange", "size", "showPages", "maxVisible"]),
    r = () => Bl(e.page, e.totalPages, e.maxVisible ?? 5);
  return (() => {
    var o = Al(), i = o.firstChild, s = i.nextSibling;
    return I(
      o,
      A({
        get class() {
      ...
      D(a => {
        ...
        return l !== a.e && (i.disabled = a.e = l), c !== a.t && (s.disabled = a.t = c), a;
      }, { e: void 0, t: void 0 }),
      o;
  })();
}
    ...
    get children() {
      return [
        d(Ce, {
          ...
          get children() {
            return [
              d(J, { variant: "neutral", children: "Item 1" }),
              d(J, { variant: "neutral", children: "Item 2" }),
              d(J, { variant: "neutral", children: "Item 3" }),
            ];
          },
        }),
        ...
        d(pe, {
          ...
          get children() {
            return [
              d(J, { variant: "primary", children: "H1" }),
              d(J, { variant: "primary", children: "H2" }),
              d(J, { variant: "primary", children: "H3" }),
            ];
          },
        }),
      ];
...
function Wl() {
  return d(pe, {
    ...
    get children() {
      return [
        d(J, { variant: "neutral", children: "Left" }),
        d(yr, {}),
        d(J, { variant: "neutral", children: "Right" }),
      ];
    },
  });
}
function Yl() {
  return [
    (() => {
      var t = ee();
      return m(t, d(z, { variant: "primary", children: "Primary" }), null),
        m(t, d(z, { variant: "neutral", children: "Neutral" }), null),
        m(t, d(z, { variant: "danger", children: "Danger" }), null),
        m(t, d(z, { variant: "primary", disabled: !0, children: "Disabled" }), null),
        m(t, d(z, { variant: "primary", loading: !0, children: "Loading" }), null),
        t;
    })(),
    (() => {
      var t = ee();
      return m(t, d(z, { variant: "primary", size: "sm", children: "Small" }), null),
        m(t, d(z, { variant: "primary", size: "md", children: "Medium" }), null),
        m(t, d(z, { variant: "primary", size: "lg", children: "Large" }), null),
        t;
    })(),
  ];
}
...
function Zl() {
  return (() => {
    ...
    return m(t, d(J, { variant: "primary", children: "Primary" }), null),
      m(t, d(J, { variant: "neutral", children: "Neutral" }), null),
      m(t, d(J, { variant: "danger", children: "Danger" }), null),
      m(t, d(J, { variant: "success", children: "Success" }), null),
      m(t, d(J, { variant: "warning", children: "Warning" }), null),
      m(t, d(J, { variant: "info", children: "Info" }), null),
      t;
  })();
}
function ec() {
    ...
    return m(
      ...
      m(
        ...
        d(ct, {
          ...
          placement: "bottom",
          get children() {
            return d(z, { variant: "neutral", size: "sm", children: "Bottom" });
          },
        }),
        null,
      ),
      m(
        ...
        d(ct, {
          ...
          placement: "left",
          get children() {
            return d(z, { variant: "neutral", size: "sm", children: "Left" });
          },
        }),
        null,
      ),
      m(
        ...
        d(ct, {
          ...
          placement: "right",
          get children() {
            return d(z, { variant: "neutral", size: "sm", children: "Right" });
          },
        }),
        null,
      ),
  ...
  return d(Pr, {
    ...
    get children() {
      return d(pe, {
        ...
        get children() {
          return [
            d(Ue, { value: "a", label: "Option A" }),
            d(Ue, { value: "b", label: "Option B" }),
            d(Ue, { value: "c", label: "Option C" }),
          ];
        },
      });
    },
  ...
  const [t, e] = T(""),
    ...
    i = M(() => {
      ...
      return a
        ? [...o].sort((c, p) => {
          const u = c[a], h = p[a];
          return typeof u == "number" && typeof h == "number"
            ? l === "asc" ? u - h : h - u
            : l === "asc"
            ? String(u).localeCompare(String(h))
            : String(h).localeCompare(String(u));
        })
        : o;
    });
  return d(Da, {
    columns: [{ key: "name", header: "Name", sortable: !0 }, { key: "email", header: "Email" }, {
      ...
      header: "Role",
      width: "100px",
    }, { key: "age", header: "Age", align: "end", sortable: !0 }],
    get data() {
      return i();
    },
    rowKey: a => a.id,
            ...
            d(xi, {
              get children() {
                return d(pe, {
                  ...
                  get children() {
                    return [
                      d(z, { variant: "primary", size: "sm", children: "Action" }),
                      d(z, { variant: "neutral", size: "sm", children: "Cancel" }),
                    ];
                  },
                });
              },
...
function fc() {
  return d(ws, {
    ...
    get action() {
      return d(z, { variant: "primary", size: "sm", children: "Create New" });
    },
  });
}
function gc() {
...
function Sc() {
  ...
  return [
    ...
    d(gs, {
      ...
      onClose: () => e(!1),
      get children() {
        return [d(bs, { children: "Settings" }), Hl()];
      },
    }),
  ];
}
    ...
    (() => {
      ...
      return m(
        ...
        d(z, {
          variant: "neutral",
          size: "sm",
          onClick: () => t.add({ message: "Info notification", variant: "info" }),
          children: "Info",
        }),
        null,
      ),
        m(
          ...
          d(z, {
            variant: "neutral",
            size: "sm",
            onClick: () => t.add({ message: "Success!", variant: "success" }),
            children: "Success",
          }),
          null,
        ),
        m(
          ...
          d(z, {
            variant: "neutral",
            size: "sm",
            onClick: () => t.add({ message: "Warning issued", variant: "warning" }),
            children: "Warning",
          }),
          null,
        ),
        m(
          ...
          d(z, {
            variant: "neutral",
            size: "sm",
            onClick: () => t.add({ message: "Something failed", variant: "danger" }),
            children: "Danger",
          }),
          null,
        ),
        ...
        d($r, {
          get children() {
            return [
              ...
              d(Re, { value: "tab2", children: "Details" }),
              d(Re, { value: "tab3", children: "Settings" }),
            ];
          },
        }),
        d(Oe, {
...
var Ac = v("<div class=code-wrapper><pre class=code-block><code></code></pre><button class=copy-btn>"),
  Tc = v(
  ...
  Ic = v("<div class=sidebar-category><div class=sidebar-category-label>"),
  Ec = v("<a>"),
  Bc = v("<a class=components-badge-link>"),
  Rc = v("<section class=components-category><h2>"),
  Oc = v("<div><span class=component-card-name>"),
  Lc = v("<div class=component-demo>"),
  Fc = v("<div class=component-code>"),
  zc = v("<div class=component-api>"),
  Mc = v("<div class=component-card-anchor>"),
  Nc = v("<p class=component-card-desc>"),
  en = v("<p>"),
...
function jc(t) {
  const [e, n] = T(!1);
  function r() {
    navigator.clipboard.writeText(t.code), n(!0), setTimeout(() => n(!1), 1500);
  }
  return (() => {
    var o = Ac(), i = o.firstChild, s = i.firstChild, a = i.nextSibling;
    return m(s, () => t.code), a.$$click = r, m(a, () => e() ? "Copied" : "Copy"), o;
  })();
}
const Vc = Ni,
  Xc = t => (Vl[t] ?? [t]).map(n => Vc.find(r => r.name === `${n}Props`)).filter(n => n != null),
  Jc = pn.flatMap(t => t.components);
function Uc() {
  const [t, e] = T(""),
    [n, r] = T(""),
    o = M(() => {
      ...
      return l
        ? pn.map(c => ({ ...c, components: c.components.filter(p => p.toLowerCase().includes(l)) })).filter(c =>
          c.components.length > 0
        )
        : pn;
    }),
    i = M(() => o().flatMap(l => l.components));
  let s = [];
  Qn(() => {
    ...
    ne(() => {
      for (const l of s) l.disconnect();
    });
  const a = l => {
    const c = document.getElementById(`component-${l}`);
  ...
  return (() => {
    var l = Tc(),
      ...
      f = c.nextSibling,
      g = f.firstChild;
    return u.$$input = b => e(b.currentTarget.value),
      m(
        h,
        d(Y, {
          get each() {
                    ...
                    children: S =>
                      (() => {
                        ...
                        return $.$$click = _ => {
                          ...
                          w($, "href", `#component-${S}`),
                          m($, S),
                          D(() => G($, `sidebar-link${n() === S ? " sidebar-link--active" : ""}`)),
                          $;
                      })(),
                  }),
                  null,
          ...
          children: b =>
            (() => {
              ...
              return y.$$click = P => {
                ...
                w(y, "href", `#component-${b}`),
                m(y, d(J, { variant: "neutral", size: "sm", children: b })),
                y;
            })(),
        }),
      ),
      ...
      D(() => w(u, "placeholder", B(E(), "ui.search"))),
      D(() => u.value = t()),
      l;
  })();
}
                        ...
                        get children() {
                          return [
                            d(Re, {
                              value: "demo",
                              get children() {
                                return B(E(), "ui.tabDemo");
                              },
                            }),
                            d(Re, {
                              value: "code",
                              get children() {
                                return B(E(), "ui.tabCode");
                              },
                            }),
                            d(Re, {
                              value: "api",
                              get children() {
                                return B(E(), "ui.tabApi");
                              },
                            }),
                          ];
                        },
...
function Yc() {
  return d(ri, {
    ...
    get children() {
      return [
        d(Ht, { path: "/", component: wi }),
        d(Ht, { path: "/getting-started", component: Mi }),
        d(Ht, { path: "/components", component: Uc }),
      ];
    },
  });
}
const Xn = document.getElementById("app");
Xn && vo(() => d(Yc, {}), Xn);
