...
function Ee(t, e) {
  const n = N,
    ...
    o = t.length === 0,
    s = e === void 0 ? r : e,
    i = o ? Wn : { owned: null, cleanups: null, context: s ? s.context : null, owner: s },
    a = o ? t : () => t(() => Z(() => We(i)));
  L = i, N = null;
  try {
    return we(a, !0);
  ...
  return (!t.comparator || !t.comparator(r, e)) && (t.value = e,
    t.observers && t.observers.length && we(() => {
      for (let o = 0; o < t.observers.length; o += 1) {
        const s = t.observers[o], i = Ft && Ft.running;
        i && Ft.disposed.has(s),
          (i ? !s.tState : !s.state) && (s.pure ? j.push(s) : de.push(s), s.observers && nr(s)),
          i || (s.state = Pe);
      }
...
function eo(t, e, n) {
  ...
  try {
    ...
    return t.pure && (t.state = Pe, t.owned && t.owned.forEach(We), t.owned = null), t.updatedAt = n + 1, gn(i);
  } finally {
    N = s, L = o;
  }
...
function fn(t, e, n, r = Pe, o) {
  ...
  return L === null || L !== Wn && (L.owned ? L.owned.push(s) : L.owned = [s]), s;
}
function ft(t) {
  if (t.state === 0) return;
  ...
  if (t.sources) {
    for (; t.sources.length;) {
      ...
      if (o && o.length) {
        ...
        r < o.length && (s.sourceSlots[i] = r, o[r] = s, n.observerSlots[r] = i);
      }
    }
  }
  if (t.tOwned) {
...
function io(t, e, n = {}) {
  let r = [], o = [], s = [], i = 0, a = e.length > 1 ? [] : null;
  return ne(() => $n(s)), () => {
    ...
    return l[tn],
      Z(() => {
        let f, g, b, y, P, S, $, _, R;
        if (c === 0) {
          i !== 0 && ($n(s), s = [], r = [], o = [], i = 0, a && (a = [])),
            n.fallback && (r = [so], o[0] = Ee(H => (s[0] = H, n.fallback())), i = 1);
        } else if (i === 0) {
          for (o = new Array(c), u = 0; u < c; u++) r[u] = l[u], o[u] = Ee(h);
          i = c;
        } else {
          for (
            b = new Array(c), y = new Array(c), a && (P = new Array(c)), S = 0, $ = Math.min(i, c);
            S < $ && r[S] === l[S];
            S++
          );
          for ($ = i - 1, _ = c - 1; $ >= S && _ >= S && r[$] === l[_]; $--, _--) {
            b[_] = o[$], y[_] = s[$], a && (P[_] = a[$]);
          }
          ...
          for (p = S; p <= $; p++) {
            R = r[p],
              u = f.get(R),
              u !== void 0 && u !== -1
                ? (b[u] = o[p], y[u] = s[p], a && (P[u] = a[p]), u = g[u], f.set(R, u))
                : s[p]();
          }
          for (u = S; u < c; u++) u in b ? (o[u] = b[u], s[u] = y[u], a && (a[u] = P[u], a[u](u))) : o[u] = Ee(h);
          o = o.slice(0, i = c), r = l.slice(0);
        }
        return o;
      });
    function h(f) {
...
function A(...t) {
  ...
  for (let i = 0; i < t.length; i++) {
    const a = t[i];
    e = e || !!a && te in a, t[i] = typeof a == "function" ? (e = !0, M(a)) : a;
  }
  if (Jn && e) {
    return new Proxy({
      get(i) {
      ...
      has(i) {
        for (let a = t.length - 1; a >= 0; a--) if (i in zt(t[a])) return !0;
        return !1;
      },
      keys() {
        const i = [];
        for (let a = 0; a < t.length; a++) i.push(...Object.keys(zt(t[a])));
        return [...new Set(i)];
      },
    }, on);
  }
...
function x(t, ...e) {
  ...
  if (Jn && te in t) {
    ...
    return s.push(
      new Proxy({
        get(i) {
          return o.includes(i) ? void 0 : t[i];
        },
        has(i) {
          return o.includes(i) ? !1 : i in t;
        },
        keys() {
...
function Y(t) {
  ...
  return M(io(() => t.each, t.children, e || void 0));
}
function k(t) {
  const e = t.keyed, n = M(() => t.when, void 0, void 0), r = e ? n : M(n, void 0, { equals: (o, s) => !o == !s });
  return M(
    () => {
      const o = r();
      if (o) {
...
const bo = new Set([
  ...
  U = t => M(() => t());
function yo(t, e, n) {
  let r = n.length, o = e.length, s = r, i = 0, a = 0, l = e[o - 1].nextSibling, c = null;
  for (; i < o || a < s;) {
    if (e[i] === n[a]) {
      i++, a++;
      continue;
    ...
    for (; e[o - 1] === n[s - 1];) o--, s--;
    if (o === i) {
      const p = s < r ? a ? n[a - 1].nextSibling : n[s - a] : l;
      for (; a < s;) t.insertBefore(n[a++], p);
    } else if (s === a) { for (; i < o;) (!c || !c.has(e[i])) && e[i].remove(), i++; }
    else if (e[i] === n[s - 1] && n[a] === e[o - 1]) {
      const p = e[--o].nextSibling;
      t.insertBefore(n[a++], e[i++].nextSibling), t.insertBefore(n[--s], p), e[o] = n[s];
    } else {
      if (!c) {
        c = new Map();
        let u = a;
      ...
      if (p != null) {
        if (a < p && p < s) {
          let u = i, h = 1, f;
          for (; ++u < o && u < s && !((f = c.get(e[u])) == null || f !== p + h);) h++;
          if (h > p - a) {
            const g = e[i];
...
function vo(t, e, n, r = {}) {
  let o;
  return Ee(s => {
    o = s, e === document ? t() : m(e, t(), e.firstChild ? null : void 0, n);
  }, r.owner),
    () => {
      o(), e.textContent = "";
    };
...
function q(t, e = window.document) {
  ...
  for (let r = 0, o = t.length; r < o; r++) {
    const s = t[r];
    n.has(s) || (n.add(s), e.addEventListener(s, xo));
  }
}
function w(t, e, n) {
...
function wo(t, e, n) {
  ...
  for (s in e) o = e[s], o !== n[s] && (r.setProperty(s, o), n[s] = o);
  return n;
}
function or(t, e, n) {
...
function Co(t, e, n, r, o = {}, s = !1) {
  e || (e = {});
  for (const i in o) {
    if (!(i in e)) {
      if (i === "children") continue;
      o[i] = kn(t, i, null, o[i], n, s, e);
    }
  }
  for (const i in e) {
    if (i === "children") continue;
    const a = e[i];
    o[i] = kn(t, i, a, o[i], n, s, e);
  }
}
function $o(t) {
...
function _n(t, e, n) {
  ...
  for (let o = 0, s = r.length; o < s; o++) t.classList.toggle(r[o], n);
}
function kn(t, e, n, r, o, s, i) {
  let a, l, c, p, u;
...
function xo(t) {
  ...
  const n = `$$${t.type}`,
    r = t.target,
    o = t.currentTarget,
    s = l => Object.defineProperty(t, "target", { configurable: !0, value: l }),
    i = () => {
      const l = e[n];
      if (l && !e.disabled) {
        const c = e[`${n}Data`];
...
function Ye(t, e, n, r, o) {
  ...
  if (e === n) return n;
  const s = typeof e, i = r !== void 0;
  if (t = i && n[0] && n[0].parentNode || t, s === "string" || s === "number") {
    if (s === "number" && (e = e.toString(), e === n)) return n;
    if (i) {
      let a = n[0];
  ...
  } else if (e == null || s === "boolean") n = Ie(t, n, r);
  else {
    if (s === "function") {
      return D(() => {
        let a = e();
    ...
    if (Array.isArray(e)) {
      ...
      if (a.length === 0) { if (n = Ie(t, n, r), i) return n; }
      else l ? n.length === 0 ? Dn(t, a, r) : yo(t, n, a) : (n && Ie(t), Dn(t, a));
      n = a;
    } else if (e.nodeType) {
      if (Array.isArray(n)) {
        if (i) return n = Ie(t, n, r, e);
        Ie(t, n, null, e);
  ...
  if (e.length) {
    ...
    for (let i = e.length - 1; i >= 0; i--) {
      ...
      if (o !== a) {
        ...
        !s && !i ? l ? t.replaceChild(o, a) : t.insertBefore(o, n) : l && a.remove();
      } else s = !0;
    }
...
function tt(t) {
  ...
  return ie(
    () => {
      s || (s = mn(o, () => M(() => t.children)));
      const i = r();
      if (i instanceof HTMLHeadElement) {
        const [a, l] = I(!1), c = () => l(!0);
        Ee(p => m(i, () => a() ? p() : s(), null)), ne(c);
      } else {
...
function sr() {
  ...
  function r(o, s) {
    if (n) return !(n = !1);
    const i = { to: o, options: s, defaultPrevented: !1, preventDefault: () => i.defaultPrevented = !0 };
    for (const a of t) {
      a.listener({
        ...i,
        from: a.location,
        retry: l => {
          l && (n = !0), a.navigate(o, { ...s, resolve: !1 });
        },
      });
    }
...
const Io = /^(?:[a-z0-9]+:)?\/\//i, Eo = /^\/+|(\/)\/+$/g, ir = "http://sr";
function De(t, e = !1) {
...
function pt(t, e, n) {
  ...
  let s = "";
  return !o || e.startsWith("/") ? s = r : o.toLowerCase().indexOf(r.toLowerCase()) !== 0 ? s = r + o : s = o,
    (s || "/") + De(e, !s);
}
function Bo(t, e) {
...
function Oo(t, e, n) {
  const [r, o] = t.split("/*", 2), s = r.split("/").filter(Boolean), i = s.length;
  return a => {
    const l = a.split("/").filter(Boolean), c = l.length - i;
    if (c < 0 || c > 0 && o === void 0 && !e) return null;
    const p = { path: i ? "" : "/", params: {} }, u = h => n === void 0 ? void 0 : n[h];
    for (let h = 0; h < i; h++) {
      const f = s[h], g = f[0] === ":", b = g ? l[h] : l[h].toLowerCase(), y = g ? f.slice(1) : f.toLowerCase();
...
function cr(t) {
  ...
  return cr(r).reduce((s, i) => [...s, ...o.map(a => a + i)], []);
}
const Fo = 100,
  dr = Se(),
  yn = Se(),
  ...
  Ho = () => vn().location;
function Go(t, e = "") {
  const { component: n, preload: r, load: o, children: s, info: i } = t,
    a = !s || Array.isArray(s) && !s.length,
    l = { key: t, component: n, preload: r || o, info: i };
...
function Vo(t, e, n, r = {}) {
  const { signal: [o, s], utils: i = {} } = t,
    a = i.parsePath || (O => O),
    l = i.renderPath || (O => O),
    c = i.beforeLeave || sr(),
    p = pt("", r.base || "");
  if (p === void 0) throw new Error(`${p} is not a valid base path`);
  p && !o().value && s({ value: p, replace: !0, scroll: !1 });
  const [u, h] = I(!1);
  let f;
  const g = (O, F) => {
    ...
    qe = i.paramsWrapper ? i.paramsWrapper(le, e) : lr(le),
    $e = {
      pattern: p,
      path: () => p,
      outlet: () => null,
  ...
  function fe(O, F, K) {
    Z(() => {
      if (typeof F == "number") {
        F && (i.go ? i.go(F) : console.warn("Router integration does not support relative routing"));
        return;
      }
      const W = !F || F[0] === "?",
        { replace: V, resolve: X, scroll: je, state: Ve } = { replace: !1, resolve: !W, scroll: !0, ...K },
        it = X ? O.resolvePath(F) : pt(W && $.pathname || "", F);
      if (it === void 0) throw new Error(`Path '${F}' is not a routable path`);
      if (_.length >= Fo) throw new Error("Too many redirects");
      const Cn = b();
      (it !== Cn || Ve !== P())
        && (_o
          || c.confirm(it, K)
            && (_.push({ value: Cn, replace: V, scroll: je, state: P() }), g("navigate", { value: it, state: Ve })));
    });
  }
  function rt(O) {
  ...
  function ot(O) {
    const F = _[0];
    F && (s({ ...O, replace: F.replace, scroll: F.scroll }), _.length = 0);
  }
  function st(O, F) {
...
function Xo(t, e, n, r) {
  const { base: o, location: s, params: i } = t,
    { pattern: a, component: l, preload: c } = r().route,
    p = M(() => r().path);
  l && l.preload && l.preload();
  const u = c ? c({ params: i, location: s, intent: ke || "initial" }) : void 0;
  return {
    parent: e,
    pattern: a,
    path: p,
...
const Jo = t => e => {
  ...
  let s;
  const i = Vo(t, o, () => s, { base: n, singleFlight: e.singleFlight, transformUrl: e.transformUrl });
  return t.create && t.create(i),
    d(dr.Provider, {
      value: i,
      get children() {
        return d(Uo, {
...
function Wo(t) {
  const e = [];
  let n;
  const r = M(Te(t.routerState.matches, (o, s, i) => {
    let a = s && o.length === s.length;
    const l = [];
    for (let c = 0, p = o.length; c < p; c++) {
      const u = s && s[c], h = o[c];
      i && u && h.route.key === u.route.key ? l[c] = i[c] : (a = !1,
        e[c] && e[c](),
        Ee(f => {
          e[c] = f,
    ...
    return e.splice(o.length).forEach(c => c()), i && a ? i : (n = l[0], l);
  }));
  return An(() => r() && n)();
}
const An = t => () =>
...
function Qo(t) {
  ...
  const n = o => typeof o == "string" ? { value: o } : o,
    r = Yo(
      I(n(t.get()), { equals: (o, s) => o.value === s.value && o.state === s.state }),
      void 0,
      o => (!e && t.set(o), o),
    );
...
const ts = new Map();
function ns(t = !0, e = !1, n = "/_server", r) {
  return o => {
    const s = o.base.path(), i = o.navigatorFactory(o.base);
    let a, l;
    function c(b) {
    ...
    function p(b) {
      ...
      if (
        !(R.origin !== window.location.origin
          || s && R.pathname && !R.pathname.toLowerCase().startsWith(s.toLowerCase()))
      ) return [y, R];
    }
    function u(b) {
      const y = p(b);
...
function rs(t) {
  ...
  return Qo({
    get: e,
    set({ value: r, replace: o, scroll: s, state: i }) {
      o ? window.history.replaceState(Ao(i), "", r) : window.history.pushState(i, "", r),
        es(decodeURIComponent(window.location.hash.slice(1)), s),
        bn();
    },
    init: r =>
      Zo(
    ...
    create: ns(t.preload, t.explicitLinks, t.actionBase, t.transformUrl),
...
function Je(t) {
  ...
  const [, e] = x(t, ["href", "state", "class", "activeClass", "inactiveClass", "end"]),
    ...
    s = M(() => {
      ...
      const a = De(i.split(/[?#]/, 1)[0]).toLowerCase(), l = decodeURI(De(o.pathname).toLowerCase());
...
function hr(t) {
  let e = t[te];
  if (!e && (Object.defineProperty(t, te, { value: e = new Proxy(t, as) }), !Array.isArray(t))) {
    const n = Object.keys(t), r = Object.getOwnPropertyDescriptors(t);
    for (let o = 0, s = n.length; o < s; o++) {
      const i = n[o];
      r[i].get && Object.defineProperty(t, i, { enumerable: r[i].enumerable, get: r[i].get.bind(e) });
    }
  }
  return e;
}
...
function Ne(t, e = new Set()) {
  ...
  if (Array.isArray(t)) {
    ...
    for (let i = 0, a = t.length; i < a; i++) o = t[i], (r = Ne(o, e)) !== o && (t[i] = r);
  } else {
    Object.isFrozen(t) ? t = Object.assign({}, t) : e.add(t);
    const i = Object.keys(t), a = Object.getOwnPropertyDescriptors(t);
    for (let l = 0, c = i.length; l < c; l++) s = i[l], !a[s].get && (o = t[s], (r = Ne(o, e)) !== o && (t[s] = r));
  }
  return t;
}
function yt(t, e) {
...
function Qe(t, e, n) {
  if (t[e]) return t[e];
  const [r, o] = I(n, { equals: !1, internal: !0 });
  return r.$ = o, t[e] = r;
}
function ss(t, e) {
...
const as = {
  get(t, e, n) {
    ...
    let s = o ? o() : t[e];
    if (e === Be || e === ce || e === "__proto__") return s;
    if (!o) {
      const i = Object.getOwnPropertyDescriptor(t, e);
      nn() && (typeof s != "function" || t.hasOwnProperty(e)) && !(i && i.get) && (s = Qe(r, e, s)());
    }
    return Me(s) ? hr(s) : s;
  },
  has(t, e) {
...
function He(t, e, n, r = !1) {
  if (!r && t[e] === n) return;
  const o = t[e], s = t.length;
  n === void 0
    ? (delete t[e], t[ce] && t[ce][e] && o !== void 0 && t[ce][e].$())
    : (t[e] = n, t[ce] && t[ce][e] && o === void 0 && t[ce][e].$());
  let i = yt(t, Be), a;
  if ((a = Qe(i, e, o)) && a.$(() => n), Array.isArray(t) && t.length !== s) {
    for (let l = t.length; l < s; l++) (a = i[l]) && a.$();
    (a = Qe(i, "length", s)) && a.$(t.length);
  }
  (a = i[mr]) && a.$();
}
function gr(t, e) {
...
function Xe(t, e, n = []) {
  ...
  if (e.length > 1) {
    r = e.shift();
    const i = typeof r, a = Array.isArray(t);
    if (Array.isArray(r)) {
  ...
  let s = e[0];
  typeof s == "function" && (s = s(o, n), s === o) || r === void 0 && s == null
    || (s = Ne(s), r === void 0 || Me(o) && Me(s) && !Array.isArray(s) ? gr(o, s) : He(t, r, s));
}
function cs(...[t, e]) {
  const n = Ne(t || {}), r = Array.isArray(n), o = hr(n);
  function s(...i) {
    Yn(() => {
      r && i.length === 1 ? ls(n, i[0]) : Xe(n, i);
    });
  }
  return [o, s];
}
...
var ds = v("<span class=so-button__spinner aria-hidden=true>"),
...
function ys(t) {
  const [e, n] = I("normal"), [r, o] = I("light");
  return ie(() => {
    ...
    (() => {
      var s = bs(),
        ...
        p = c.nextSibling,
        u = i.nextSibling;
      return m(i, d(Je, { href: "/", class: "site-logo", children: "soluid" }), a),
        m(
          a,
          d(Je, {
        ...
        c.addEventListener("change", h => ms(h.currentTarget.value)),
        m(
          l,
          d(z, {
            get variant() {
...
function wr(t) {
  ...
  function r(o) {
    ...
    const a = document.activeElement, l = i.indexOf(a);
    if (l === -1) return;
    let c;
    o.key === "ArrowRight"
      ? c = (l + 1) % i.length
      : o.key === "ArrowLeft"
      ? c = (l - 1 + i.length) % i.length
      : o.key === "Home"
      ? c = 0
...
function _r(t) {
  ...
  function o(s) {
    ...
    s.shiftKey && p === l ? (s.preventDefault(), c.focus()) : !s.shiftKey && p === c && (s.preventDefault(), l.focus());
  }
          ...
          return d(Ar.Provider, {
            ...
            get children() {
              ...
              return h.addEventListener("animationend", l),
                ...
                m(f, () => e.children),
                D(() => G(h, C("so-drawer-backdrop", i() && "so-drawer-backdrop--closing"))),
                h;
            },
          });
        },
  ...
  const { x: r, y: o, platform: s, rects: i, elements: a, strategy: l } = t,
    ...
    P = xt(
      await s.getClippingRect({
        element: (n = await (s.isElement == null ? void 0 : s.isElement(y))) == null || n
          ? y
          : y.contextElement || await (s.getDocumentElement == null ? void 0 : s.getDocumentElement(a.floating)),
        boundary: c,
        rootBoundary: p,
        strategy: l,
      }),
    ),
    S = u === "floating" ? { x: r, y: o, width: i.floating.width, height: i.floating.height } : i.reference,
    $ = await (s.getOffsetParent == null ? void 0 : s.getOffsetParent(a.floating)),
    _ = await (s.isElement == null ? void 0 : s.isElement($))
      ? await (s.getScale == null ? void 0 : s.getScale($)) || { x: 1, y: 1 }
      : { x: 1, y: 1 },
    R = xt(
...
const Li = async (t, e, n) => {
  ...
  Fi = function(t) {
    return t === void 0 && (t = {}), {
      ...
      async fn(e) {
        var n, r;
        const { placement: o, middlewareData: s, rects: i, initialPlacement: a, platform: l, elements: c } = e,
          {
            mainAxis: p = !0,
            crossAxis: u = !0,
        ...
        if (fe = [...fe, { placement: o, overflows: $e }], !$e.every(O => O <= 0)) {
          var rt, ot;
          const O = (((rt = s.flip) == null ? void 0 : rt.index) || 0) + 1, F = le[O];
          if (
            F
...
const Ni = function(t) {
  ...
  Hi = function(t) {
    return t === void 0 && (t = {}), {
      ...
      options: t,
      async fn(e) {
        const { x: n, y: r, placement: o, platform: s } = e,
          {
            mainAxis: i = !0,
            crossAxis: a = !1,
            limiter: l = {
...
function Or(t, e, n) {
  var r;
  e === void 0 && (e = []);
  const o = Rr(t), s = o === ((r = t.ownerDocument) == null ? void 0 : r.body), i = Q(o);
  return s ? (un(i), e.concat(i, i.visualViewport || [], nt(o) ? o : [], [])) : e.concat(o, Or(o, []));
}
function un(t) {
...
function Lr(t) {
  ...
  const o = ae(t), s = o ? t.offsetWidth : n, i = o ? t.offsetHeight : r, a = Ct(n) !== s || Ct(r) !== i;
...
function Zi(t) {
  ...
  if (r === i || a && s) return n;
  let l = { scrollLeft: 0, scrollTop: 0 }, c = se(1);
  const p = se(0), u = ae(r);
...
function la(t, e, n) {
  ...
  s && !r && o && c();
  const p = o && !r && !s ? Mr(o, a) : se(0),
    u = i.left + a.scrollLeft - l.x - p.x,
...
function Xt(t) {
  ...
  function r() {
    var s;
    e.disabled || (s = e.onSelect) == null || s.call(e);
  }
  function o(s) {
    var i;
    ...
    return s.addEventListener("change", r),
      ...
      D(i => {
        var a = n == null ? void 0 : n.id,
          ...
          h = n != null && n.hasError ? n.errorId : n == null ? void 0 : n.hintId;
        return a !== i.e && w(s, "id", i.e = a),
          l !== i.t && G(s, i.t = l),
          c !== i.a && (s.disabled = i.a = c),
          p !== i.o && (s.required = i.o = p),
          u !== i.i && w(s, "aria-invalid", i.i = u),
          h !== i.n && w(s, "aria-describedby", i.n = h),
          i;
...
function Ua(t = {}) {
  ...
  function o(i) {
    var a;
    t.pressed || n(i), (a = t.onPressedChange) == null || a.call(t, i);
  }
  function s() {
    o(!r());
  }
  ...
  return (() => {
    ...
    return o.$$input = r,
      D(s => {
        ...
        return i !== s.e && w(o, "id", s.e = i),
          a !== s.t && G(o, s.t = a),
          l !== s.a && w(o, "placeholder", s.a = l),
          c !== s.o && w(o, "rows", s.o = c),
          p !== s.i && (o.disabled = s.i = p),
          u !== s.n && (o.required = s.n = u),
          h !== s.s && w(o, "aria-invalid", s.s = h),
          f !== s.h && w(o, "aria-describedby", s.h = f),
          s;
  ...
  return (() => {
    ...
    return o.$$input = r,
      D(s => {
        ...
        return i !== s.e && w(o, "id", s.e = i),
          a !== s.t && G(o, s.t = a),
          l !== s.a && w(o, "type", s.a = l),
          c !== s.o && w(o, "placeholder", s.o = c),
          p !== s.i && (o.disabled = s.i = p),
          u !== s.n && (o.required = s.n = u),
          h !== s.s && w(o, "aria-invalid", s.s = h),
          f !== s.h && w(o, "aria-describedby", s.h = f),
